...
PROCEDURE Main()
   ...
   oModel:setHorizontalHeaderCB( Qt_SizeHintRole, {|nCol|QSize():new( 60, 60 )} ) // sizehints das colunas
   ...
   oModel:setVerticalHeaderCB( Qt_SizeHintRole, {|nRow|QSize():new( 90, 30 )} ) // sizehints das linhas
