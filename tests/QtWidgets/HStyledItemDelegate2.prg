...
PROCEDURE Main()
   ...
   oDB:setDatabaseName("HStyledItemDelegate2.db")
...
METHOD new(...) CLASS TextDelegate
   ...
   ::setDestroyEditorCB( {|...|::destroyEditor(...)} )
...
METHOD destroyEditor(oEditor, oIndex) CLASS TextDelegate
...
METHOD destroyEditor(oEditor, oIndex) CLASS ValueDelegate
