...
HB_FUNC_STATIC(QROTATIONSENSOR_ONHASZCHANGED)
{
  ...
  if (sender != nullptr)
  {
    auto indexOfSignal = sender->metaObject()->indexOfSignal("hasZChanged(bool)");
    ...
    if (hb_pcount() == 1)
    {
      ...
      {
        auto connection =
            QObject::connect(sender, &QRotationSensor::hasZChanged, [sender, indexOfCodeBlock](bool arg1) {
              auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);

              if (cb != nullptr)
              {
                auto pSender = Qt5xHb::Signals_return_qobject(sender, "QROTATIONSENSOR");
