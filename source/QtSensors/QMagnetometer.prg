...
HB_FUNC_STATIC( QMAGNETOMETER_ONRETURNGEOVALUESCHANGED )
{
  ...
  if( sender != nullptr )
  {
    if( hb_pcount() == 1 )
    {
      if( Signals2_connection( sender, "returnGeoValuesChanged(bool)" ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals2_return_qobject ( (QObject *) sender, "QMAGNETOMETER" );
        ...
        Signals2_store_connection( sender, "returnGeoValuesChanged(bool)", connection );
    ...
    {
      Signals2_disconnection( sender, "returnGeoValuesChanged(bool)" );

      QObject::disconnect( Signals2_get_connection( sender, "returnGeoValuesChanged(bool)" ) );
