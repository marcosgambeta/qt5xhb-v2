...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QMagnetometer *>(Qt5xHb::getQObjectPointerFromSelfItem())
      ...
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection =
            QObject::connect(sender, &QMagnetometer::returnGeoValuesChanged, [sender, indexOfCodeBlock](bool arg1) {
              ...
              if (cb != nullptr) {
                auto pSender = Qt5xHb::Signals_return_qobject(sender, "QMAGNETOMETER");
