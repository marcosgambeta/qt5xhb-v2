...
void QSqlField_new1()
{
  auto obj = new QSqlField( OPQSTRING(1,QString()), HB_ISNIL(2)? (QVariant::Type) QVariant::Invalid : (QVariant::Type) hb_parni(2) );
...
{
  auto obj = (QSqlField *) Qt5xHb::itemGetPtrStackSelfItem();
