...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QSqlError *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QSQLERROR_NEW)
{
  ...
  } else if (ISBETWEEN(0, 4) && ISQSTRINGORNIL(1) && ISQSTRINGORNIL(2) && ISNUMORNIL(3) && ISQSTRINGORNIL(4)) {
