  ...
  if (obj != nullptr) {
    ...
    if (ISBETWEEN(1, 3) && ISQSIZE(1) && ISNUMORNIL(2) && ISNUMORNIL(3)) {
      ...
      RQSIZE(obj->actualSize(
          *PQSIZE(1), HB_ISNIL(2) ? static_cast<QIcon::Mode>(QIcon::Normal) : PQICON_MODE(2),
  ...
  if (obj != nullptr) {
    ...
    if (ISBETWEEN(1, 3) && ISQPIXMAP(1) && ISNUMORNIL(2) && ISNUMORNIL(3)) {
      ...
      obj->addPixmap(*PQPIXMAP(1),
                     HB_ISNIL(2) ? static_cast<QIcon::Mode>(QIcon::Normal) : PQICON_MODE(2),
                     HB_ISNIL(3) ? static_cast<QIcon::State>(QIcon::Off) : PQICON_STATE(3));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    ...
    */
    ...
    if (obj != nullptr) {
      obj->paint(PQPAINTER(1), *PQRECT(2),
                 HB_ISNIL(3) ? static_cast<Qt::Alignment>(Qt::AlignCenter) : PQT_ALIGNMENT(3),
                 HB_ISNIL(4) ? static_cast<QIcon::Mode>(QIcon::Normal) : PQICON_MODE(4),
                 HB_ISNIL(5) ? static_cast<QIcon::State>(QIcon::Off) : PQICON_STATE(5));
    }
    ...
    */
    ...
    if (obj != nullptr) {
      obj->paint(PQPAINTER(1), PINT(2), PINT(3), PINT(4), PINT(5),
                 HB_ISNIL(6) ? static_cast<Qt::Alignment>(Qt::AlignCenter) : PQT_ALIGNMENT(6),
                 HB_ISNIL(7) ? static_cast<QIcon::Mode>(QIcon::Normal) : PQICON_MODE(7),
                 HB_ISNIL(8) ? static_cast<QIcon::State>(QIcon::Off) : PQICON_STATE(8));
    }
...
HB_FUNC_STATIC(QICON_PIXMAP)
{
  if (ISBETWEEN(1, 3) && ISQSIZE(1) && ISNUMORNIL(2) && ISNUMORNIL(3)) {
    ...
    */
    ...
    if (obj != nullptr) {
      auto ptr = new QPixmap(obj->pixmap(
          PINT(1), HB_ISNIL(2) ? static_cast<QIcon::Mode>(QIcon::Normal) : PQICON_MODE(2),
          HB_ISNIL(3) ? static_cast<QIcon::State>(QIcon::Off) : PQICON_STATE(3)));
      Qt5xHb::createReturnClass(ptr, "QPIXMAP", true);
    }
  } else {
