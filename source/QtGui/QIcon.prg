...
void QIcon_new3()
{
  auto obj = new QIcon( HB_ISOBJECT(1)? *(QIcon *) Qt5xHb::itemGetPtr(1) : QIcon(hb_parc(1)) );
  Qt5xHb::returnNewObject( obj, true );
}
...
HB_FUNC_STATIC( QICON_ACTUALSIZE )
{
  ...
  if( obj != nullptr )
  {
    ...
    {
#endif
      auto ptr = new QSize( obj->actualSize( *PQSIZE(1), HB_ISNIL(2)? (QIcon::Mode) QIcon::Normal : (QIcon::Mode) hb_parni(2), HB_ISNIL(3)? (QIcon::State) QIcon::Off : (QIcon::State) hb_parni(3) ) );
...
void QIcon_pixmap1()
{
  ...
  if( obj != nullptr )
  {
    auto ptr = new QPixmap( obj->pixmap( *PQSIZE(1), HB_ISNIL(2)? (QIcon::Mode) QIcon::Normal : (QIcon::Mode) hb_parni(2), HB_ISNIL(3)? (QIcon::State) QIcon::Off : (QIcon::State) hb_parni(3) ) );
...
void QIcon_pixmap2()
{
  ...
  if( obj != nullptr )
  {
    auto ptr = new QPixmap( obj->pixmap( PINT(1), PINT(2), HB_ISNIL(3)? (QIcon::Mode) QIcon::Normal : (QIcon::Mode) hb_parni(3), HB_ISNIL(4)? (QIcon::State) QIcon::Off : (QIcon::State) hb_parni(4) ) );
    Qt5xHb::createReturnClass( ptr, "QPIXMAP", true );
  }
}
...
void QIcon_pixmap3()
{
  ...
  if( obj != nullptr )
  {
    auto ptr = new QPixmap( obj->pixmap( PINT(1), HB_ISNIL(2)? (QIcon::Mode) QIcon::Normal : (QIcon::Mode) hb_parni(2), HB_ISNIL(3)? (QIcon::State) QIcon::Off : (QIcon::State) hb_parni(3) ) );
    Qt5xHb::createReturnClass( ptr, "QPIXMAP", true );
  }
}
...
HB_FUNC_STATIC( QICON_FROMTHEME )
{
  ...
  {
#endif
    auto ptr = new QIcon( QIcon::fromTheme( PQSTRING(1), HB_ISNIL(2)? QIcon() : *(QIcon *) Qt5xHb::itemGetPtr(2) ) );
