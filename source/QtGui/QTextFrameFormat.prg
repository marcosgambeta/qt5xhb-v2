...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QTextFrameFormat *>(Qt5xHb::itemGetPtrStackSelfItem())
...
#endif
      obj->setPosition(PQTEXTFRAMEFORMAT_POSITION(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QTEXTFRAMEFORMAT_SETBORDERSTYLE)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setBorderStyle(PQTEXTFRAMEFORMAT_BORDERSTYLE(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QTEXTFRAMEFORMAT_SETPAGEBREAKPOLICY)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setPageBreakPolicy(PQTEXTFRAMEFORMAT_PAGEBREAKFLAGS(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
