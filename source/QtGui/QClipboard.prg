...
HB_FUNC_STATIC(QCLIPBOARD_IMAGE)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISBETWEEN(0, 1) && ISNUMORNIL(1)) {
#endif
      auto ptr = new QImage(obj->image(HB_ISNIL(1) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(1)));
...
HB_FUNC_STATIC(QCLIPBOARD_MIMEDATA)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISBETWEEN(0, 1) && ISNUMORNIL(1)) {
#endif
      auto ptr = obj->mimeData(HB_ISNIL(1) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(1));
...
HB_FUNC_STATIC(QCLIPBOARD_PIXMAP)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISBETWEEN(0, 1) && ISNUMORNIL(1)) {
#endif
      auto ptr = new QPixmap(obj->pixmap(HB_ISNIL(1) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(1)));
