...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QClipboard *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
      obj->clear(HB_ISNIL(1) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
...
HB_FUNC_STATIC(QCLIPBOARD_IMAGE)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISBETWEEN(0, 1) && ISNUMORNIL(1)) {
#endif
      RQIMAGE(obj->image(HB_ISNIL(1) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QCLIPBOARD_MIMEDATA)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISBETWEEN(0, 1) && ISNUMORNIL(1)) {
#endif
      const auto ptr = obj->mimeData(HB_ISNIL(1) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(1));
...
HB_FUNC_STATIC(QCLIPBOARD_PIXMAP)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISBETWEEN(0, 1) && ISNUMORNIL(1)) {
#endif
      RQPIXMAP(obj->pixmap(HB_ISNIL(1) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
#endif
      obj->setImage(*PQIMAGE(1), HB_ISNIL(2) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(2));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
#endif
      obj->setMimeData(PQMIMEDATA(1), HB_ISNIL(2) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(2));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
#endif
      obj->setPixmap(*PQPIXMAP(1), HB_ISNIL(2) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(2));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QCLIPBOARD_TEXT)
{
  if (ISBETWEEN(0, 1) && ISNUMORNIL(1)) {
    ...
    if (obj != nullptr) {
      ...
      RQSTRING(obj->text(par1, HB_ISNIL(2) ? QClipboard::Clipboard : PQCLIPBOARD_MODE(2)));
