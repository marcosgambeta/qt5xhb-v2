...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QPixmap *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QPIXMAP_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    auto obj =
        new QPixmap(PQSTRING(1), OPCONSTCHAR(2, nullptr), HB_ISNIL(3) ? Qt::AutoColor : PQT_IMAGECONVERSIONFLAGS(3));
    Qt5xHb::returnNewObject(obj, true);
...
HB_FUNC_STATIC(QPIXMAP_FILL)
{
  if (ISBETWEEN(0, 1) && (ISQCOLOR(1) || HB_ISCHAR(1) || HB_ISNIL(1))) {
    ...
    RETURN_SELF();
  } else if (ISNUMPAR(2) && ISQPAINTDEVICE(1) && ISQPOINT(2)) {
    ...
    RETURN_SELF();
  } else if (ISNUMPAR(3) && ISQPAINTDEVICE(1) && HB_ISNUM(2) && HB_ISNUM(3)) {
...
#endif
      RBOOL(obj->load(PQSTRING(1), OPCONSTCHAR(2, nullptr), HB_ISNIL(3) ? Qt::AutoColor : PQT_IMAGECONVERSIONFLAGS(3)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QPIXMAP_LOADFROMDATA)
{
  if (ISBETWEEN(2, 4) && HB_ISCHAR(1) && HB_ISNUM(2) && ISCHARORNIL(3) && ISNUMORNIL(4)) {
    ...
    if (obj != nullptr) {
      RBOOL(obj->loadFromData(PCONSTUCHAR(1), PUINT(2), OPCONSTCHAR(3, nullptr),
                              HB_ISNIL(4) ? Qt::AutoColor : PQT_IMAGECONVERSIONFLAGS(4)));
    }
    ...
    if (obj != nullptr) {
      RBOOL(obj->loadFromData(*PQBYTEARRAY(1), OPCONSTCHAR(2, nullptr),
                              HB_ISNIL(3) ? Qt::AutoColor : PQT_IMAGECONVERSIONFLAGS(3)));
    }
  } else {
    hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
  }
...
#endif
      RBOOL(obj->convertFromImage(*PQIMAGE(1), HB_ISNIL(2) ? Qt::AutoColor : PQT_IMAGECONVERSIONFLAGS(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QPIXMAP_TOVARIANT)
{
  if (ISNUMPAR(0)) {
    ...
    auto pixmap = static_cast<QPixmap *>(hb_itemGetPtr(hb_objSendMsg(hb_param(1, HB_IT_OBJECT), "POINTER", 0)));
    auto variant = new QVariant();
...
HB_FUNC_STATIC(QPIXMAP_FROMVARIANT)
{
  if (ISNUMPAR(1) && ISQVARIANT(1)) {
    ...
    auto pixmap = new QPixmap(variant->value<QPixmap>());
