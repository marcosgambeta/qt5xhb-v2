...
{
  auto obj = new QTextDocumentWriter ( PQSTRING(1), ISNIL(2)? QByteArray() : *(QByteArray *) _qt5xhb_itemGetPtr(2) );
  _qt5xhb_returnNewObject( obj, false );
}
...
{
  auto obj = (QTextDocumentWriter *) _qt5xhb_itemGetPtrStackSelfItem();
