...
HB_FUNC_STATIC(QTABLETEVENT_NEW)
{
  if (ISNUMPAR(13) && HB_ISNUM(1) && ISQPOINTF(2) && ISQPOINTF(3) && HB_ISNUM(4) && HB_ISNUM(5) && HB_ISNUM(6) &&
    ...
    auto obj = new QTabletEvent(PQEVENT_TYPE(1), *PQPOINTF(2), *PQPOINTF(3), PINT(4), PINT(5), PQREAL(6), PINT(7),
                                PINT(8), PQREAL(9), PQREAL(10), PINT(11), PQT_KEYBOARDMODIFIERS(12), PQINT64(13));
