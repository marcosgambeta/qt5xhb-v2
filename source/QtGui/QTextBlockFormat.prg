...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QTextBlockFormat *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QTEXTBLOCKFORMAT_SETPAGEBREAKPOLICY)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setPageBreakPolicy(PQTEXTBLOCKFORMAT_PAGEBREAKFLAGS(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
