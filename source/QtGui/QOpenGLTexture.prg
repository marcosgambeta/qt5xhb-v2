...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QOpenGLTexture *>(Qt5xHb::itemGetPtrStackSelfItem())
...
#if (QT_VERSION >= QT_VERSION_CHECK(5, 2, 0))
    auto obj = new QOpenGLTexture(PQOPENGLTEXTURE_TARGET(1));
...
HB_FUNC_STATIC(QOPENGLTEXTURE_BIND)
{
  if (ISNUMPAR(0)) {
    ...
    if (obj != nullptr) {
      obj->bind(PUINT(1), HB_ISNIL(2) ? QOpenGLTexture::DontResetTextureUnit : PQOPENGLTEXTURE_TEXTUREUNITRESET(2));
    }
...
HB_FUNC_STATIC(QOPENGLTEXTURE_RELEASE)
{
  if (ISNUMPAR(0)) {
    ...
    if (obj != nullptr) {
      obj->release(PUINT(1), HB_ISNIL(2) ? QOpenGLTexture::DontResetTextureUnit : PQOPENGLTEXTURE_TEXTUREUNITRESET(2));
    }
...
HB_FUNC_STATIC(QOPENGLTEXTURE_SETFORMAT)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setFormat(PQOPENGLTEXTURE_TEXTUREFORMAT(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QOPENGLTEXTURE_SWIZZLEMASK)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      RENUM(obj->swizzleMask(PQOPENGLTEXTURE_SWIZZLECOMPONENT(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QOPENGLTEXTURE_SETDEPTHSTENCILMODE)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setDepthStencilMode(PQOPENGLTEXTURE_DEPTHSTENCILMODE(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QOPENGLTEXTURE_SETMINIFICATIONFILTER)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setMinificationFilter(PQOPENGLTEXTURE_FILTER(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QOPENGLTEXTURE_SETMAGNIFICATIONFILTER)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setMagnificationFilter(PQOPENGLTEXTURE_FILTER(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QOPENGLTEXTURE_WRAPMODE)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      RENUM(obj->wrapMode(PQOPENGLTEXTURE_COORDINATEDIRECTION(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
#if (QT_VERSION >= QT_VERSION_CHECK(5, 2, 0))
    RGLUINT(QOpenGLTexture::boundTextureId(PQOPENGLTEXTURE_BINDINGTARGET(1)));
#endif
  } else if (ISNUMPAR(2) && HB_ISNUM(1) && HB_ISNUM(2)) {
    // static GLuint boundTextureId(uint unit, QOpenGLTexture::BindingTarget target)
#if (QT_VERSION >= QT_VERSION_CHECK(5, 2, 0))
    RGLUINT(QOpenGLTexture::boundTextureId(PUINT(1), PQOPENGLTEXTURE_BINDINGTARGET(2)));
#endif
  } else {
    THROW_ERROR_3012();
  }
...
HB_FUNC_STATIC(QOPENGLTEXTURE_HASFEATURE)
{
  ...
  if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
    RBOOL(QOpenGLTexture::hasFeature(PQOPENGLTEXTURE_FEATURE(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  } else {
    THROW_ERROR_3012();
  }
