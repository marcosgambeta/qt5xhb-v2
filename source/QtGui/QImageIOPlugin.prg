...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QImageIOPlugin *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
      auto ptr = obj->create(PQIODEVICE(1), HB_ISNIL(2) ? QByteArray() : *PQBYTEARRAY(2));
