...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QRawFont *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QRAWFONT_BOUNDINGRECT)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      RQRECTF(obj->boundingRect(PQUINT32(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
#endif
    RQRAWFONT(QRawFont::fromFont(*PQFONT(1), HB_ISNIL(2) ? QFontDatabase::Any : PQFONTDATABASE_WRITINGSYSTEM(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  } else {
    hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
  }
