...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QTransform *>(Qt5xHb::itemGetPtrStackSelfItem())

HB_FUNC_STATIC(QTRANSFORM_NEW)
{
  if (ISNUMPAR(1) && HB_ISNUM(1)) {
    // QTransform(Qt::Initialization)
    auto obj = new QTransform(PQT_INITIALIZATION(1));
    ...
    auto obj = new QTransform(PQREAL(1), PQREAL(2), PQREAL(3), PQREAL(4), PQREAL(5), PQREAL(6), PQREAL(7), PQREAL(8),
                              OPQREAL(9, 1.0));
    Qt5xHb::returnNewObject(obj, true);
...
#endif
      auto ptr = &obj->rotate(PQREAL(1), HB_ISNIL(2) ? Qt::ZAxis : PQT_AXIS(2));
      Qt5xHb::createReturnClass(ptr, "QTRANSFORM", false);
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
...
HB_FUNC_STATIC(QTRANSFORM_ROTATERADIANS)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISBETWEEN(1, 2) && HB_ISNUM(1) && ISNUMORNIL(2)) {
#endif
      auto ptr = &obj->rotateRadians(PQREAL(1), HB_ISNIL(2) ? Qt::ZAxis : PQT_AXIS(2));
      Qt5xHb::createReturnClass(ptr, "QTRANSFORM", false);
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
...
HB_FUNC_STATIC(QTRANSFORM_FROMTRANSLATE)
{
  ...
  if (ISNUMPAR(2) && HB_ISNUM(1) && HB_ISNUM(2)) {
#endif
    RQTRANSFORM(QTransform::fromTranslate(PQREAL(1), PQREAL(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  } else {
    hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
  }
...
HB_FUNC_STATIC(QTRANSFORM_FROMSCALE)
{
  ...
  if (ISNUMPAR(2) && HB_ISNUM(1) && HB_ISNUM(2)) {
#endif
    RQTRANSFORM(QTransform::fromScale(PQREAL(1), PQREAL(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  } else {
    hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
  }
