...
void QBrush_new3()
{
  auto obj = new QBrush( HB_ISOBJECT(1)? *(QColor *) Qt5xHb::itemGetPtr(1) : QColor(hb_parc(1)), HB_ISNIL(2)? (Qt::BrushStyle) Qt::SolidPattern : (Qt::BrushStyle) hb_parni(2) );
  Qt5xHb::returnNewObject( obj, true );
}
...
void QBrush_new4()
{
  auto obj = new QBrush( (Qt::GlobalColor) hb_parni(1), HB_ISNIL(2)? (Qt::BrushStyle) Qt::SolidPattern : (Qt::BrushStyle) hb_parni(2) );
  Qt5xHb::returnNewObject( obj, true );
}
...
void QBrush_new5()
{
  auto obj = new QBrush( HB_ISOBJECT(1)? *(QColor *) Qt5xHb::itemGetPtr(1) : QColor(hb_parc(1)), *PQPIXMAP(2) );
  Qt5xHb::returnNewObject( obj, true );
}
...
HB_FUNC_STATIC( QBRUSH_NEW )
{
  ...
  else if( ISBETWEEN(1,2) && (ISQCOLOR(1)||ISCHAR(1)) && (HB_ISNUM(2)||HB_ISNIL(2)) )
  {
    QBrush_new3();
  }
