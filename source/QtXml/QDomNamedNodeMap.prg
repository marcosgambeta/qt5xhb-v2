...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QDomNamedNodeMap *>(Qt5xHb::itemGetPtrStackSelfItem())
...
#endif
      RQDOMNODE(obj->namedItemNS(PQSTRING(1), PQSTRING(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QDOMNAMEDNODEMAP_REMOVENAMEDITEM)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISCHAR(1)) {
#endif
      RQDOMNODE(obj->removeNamedItem(PQSTRING(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QDOMNAMEDNODEMAP_REMOVENAMEDITEMNS)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(2) && HB_ISCHAR(1) && HB_ISCHAR(2)) {
#endif
      RQDOMNODE(obj->removeNamedItemNS(PQSTRING(1), PQSTRING(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
#endif
      RQDOMNODE(obj->setNamedItem(*PQDOMNODE(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QDOMNAMEDNODEMAP_SETNAMEDITEMNS)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && ISQDOMNODE(1)) {
#endif
      RQDOMNODE(obj->setNamedItemNS(*PQDOMNODE(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
