...
#endif
      RQDOMATTR(obj->attributeNode(PQSTRING(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
#endif
      RQDOMATTR(obj->attributeNodeNS(PQSTRING(1), PQSTRING(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
#endif
      RQDOMATTR(obj->removeAttributeNode(*PQDOMATTR(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QDOMELEMENT_SETATTRIBUTENS2)
{
  ...
  if (obj != nullptr) {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if (ISNUMPAR(3) && ISQSTRING(1) && ISQSTRING(2) && HB_ISNUM(3)) {
#endif
...
HB_FUNC_STATIC(QDOMELEMENT_SETATTRIBUTENODE)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && ISQDOMATTR(1)) {
#endif
      RQDOMATTR(obj->setAttributeNode(*PQDOMATTR(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QDOMELEMENT_SETATTRIBUTENODENS)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && ISQDOMATTR(1)) {
#endif
      RQDOMATTR(obj->setAttributeNodeNS(*PQDOMATTR(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
