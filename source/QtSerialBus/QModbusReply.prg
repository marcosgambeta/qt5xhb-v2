...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QModbusReply *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(QMODBUSREPLY_NEW)
{
  ...
  if (ISBETWEEN(2, 3) && HB_ISNUM(1) && HB_ISNUM(2) && ISQOBJECTORNIL(3)) {
    auto obj = new QModbusReply(PQMODBUSREPLY_REPLYTYPE(1), PINT(2), OPQOBJECT(3, nullptr));
