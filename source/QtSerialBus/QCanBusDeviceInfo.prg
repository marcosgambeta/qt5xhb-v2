...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QCanBusDeviceInfo *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QCANBUSDEVICEINFO_NEWFROM)
{
  NEWFROM();
}

HB_FUNC_STATIC(QCANBUSDEVICEINFO_NEWFROMOBJECT)
{
  HB_FUNC_EXEC(QCANBUSDEVICEINFO_NEWFROM);
}

HB_FUNC_STATIC(QCANBUSDEVICEINFO_NEWFROMPOINTER)
{
  HB_FUNC_EXEC(QCANBUSDEVICEINFO_NEWFROM);
}

HB_FUNC_STATIC(QCANBUSDEVICEINFO_SELFDESTRUCTION)
{
  SELFDESTRUCTION();
}

HB_FUNC_STATIC(QCANBUSDEVICEINFO_SETSELFDESTRUCTION)
{
  SETSELFDESTRUCTION();
}
