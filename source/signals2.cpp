...
/*
  constructor
*/
Signals2::Signals2(QObject *parent) : QObject(parent)
{
  mutex = new QMutex();
}
...
/*
        ...
        {
*/
          Signals2_connect_signal( object, signal, codeblock ); // se conectado, adiciona
          ret = true;
/*
        }
        else
...
/*
    ...
    {
*/
      Signals2_disconnect_signal( object, signal ); // se desconectado, remove
      ret = true;
/*
    }
*/
