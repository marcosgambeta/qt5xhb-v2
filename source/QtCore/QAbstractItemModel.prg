    ...
    if( hb_pcount() == 1 )
    {
      if( Signals5_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals5_return_qobject( (QObject *) sender, "QABSTRACTITEMMODEL" );
      ...
      if( Signals5_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            ...
            PHB_ITEM pArg2 = hb_itemPutNI( NULL, arg2 );
            PHB_ITEM pArg3 = hb_itemPutNI( NULL, arg3 );
            PHB_ITEM pArg4 = Signals5_return_object( (void *) &arg4, "QMODELINDEX" );
      ...
      if( Signals5_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals5_return_qobject( (QObject *) sender, "QABSTRACTITEMMODEL" );
            PHB_ITEM pArg1 = Signals5_return_object( (void *) &arg1, "QMODELINDEX" );
            PHB_ITEM pArg2 = Signals5_return_object( (void *) &arg2, "QMODELINDEX" );
