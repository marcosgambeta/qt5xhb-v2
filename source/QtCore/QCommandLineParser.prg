...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QCommandLineParser *>(Qt5xHb::itemGetPtrStackSelfItem())
...
#endif
      obj->setSingleDashWordOptionMode(PQCOMMANDLINEPARSER_SINGLEDASHWORDOPTIONMODE(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QCOMMANDLINEPARSER_ADDVERSIONOPTION)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQCOMMANDLINEOPTION(obj->addVersionOption());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QCOMMANDLINEPARSER_ADDHELPOPTION)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQCOMMANDLINEOPTION(obj->addHelpOption());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
