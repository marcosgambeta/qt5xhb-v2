...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QUrl *>(Qt5xHb::itemGetPtrStackSelfItem())
...
#endif
    RQBYTEARRAY(QUrl::toPercentEncoding(PQSTRING(1), HB_ISNIL(2) ? QByteArray() : *PQBYTEARRAY(2),
