...
{
  auto obj = new QEasingCurve( HB_ISNIL(1)? (QEasingCurve::Type) QEasingCurve::Linear : (QEasingCurve::Type) hb_parni(1) );
...
{
  auto obj = (QEasingCurve *) Qt5xHb::itemGetPtrStackSelfItem();
