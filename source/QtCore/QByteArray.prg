...
{
  auto obj = (QByteArray *) Qt5xHb::itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QBYTEARRAY_APPEND6 )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISNUMPAR(2) && ISNUM(1) && (ISNUM(2)||ISCHAR(2)) )
    {
#endif
...
HB_FUNC_STATIC( QBYTEARRAY_FILL )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISBETWEEN(1,2) && (ISNUM(1)||ISCHAR(1)) && (ISNUM(2)||ISNIL(2)) )
    {
#endif
...
HB_FUNC_STATIC( QBYTEARRAY_LEFTJUSTIFIED )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISBETWEEN(1,3) && ISNUM(1) && (ISNUM(2)||ISCHAR(2)||ISNIL(2)) && (ISLOG(3)||ISNIL(3)) )
    {
#endif
...
HB_FUNC_STATIC( QBYTEARRAY_REPLACE11 )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISNUMPAR(2) && (ISNUM(1)||ISCHAR(1)) && ISQBYTEARRAY(2) )
    {
#endif
...
HB_FUNC_STATIC( QBYTEARRAY_REPLACE12 )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISNUMPAR(2) && (ISNUM(1)||ISCHAR(1)) && ISCHAR(2) )
    {
#endif
...
HB_FUNC_STATIC( QBYTEARRAY_REPLACE14 )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISNUMPAR(2) && (ISNUM(1)||ISCHAR(1)) && (ISNUM(2)||ISCHAR(2)) )
    {
#endif
...
HB_FUNC_STATIC( QBYTEARRAY_SETNUM7 )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISBETWEEN(1,3) && ISNUM(1) && (ISNUM(2)||ISCHAR(2)||ISNIL(2)) && (ISNUM(3)||ISNIL(3)) )
    {
#endif
...
HB_FUNC_STATIC( QBYTEARRAY_TOINT )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISBETWEEN(0,2) && (ISLOG(1)||ISNIL(1)) && (ISNUM(2)||ISNIL(2)) )
    {
#endif
      bool par1;
...
HB_FUNC_STATIC( QBYTEARRAY_TOPERCENTENCODING )
{
  ...
  {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if( ISBETWEEN(0,3) && (ISQBYTEARRAY(1)||ISNIL(1)) && (ISQBYTEARRAY(2)||ISNIL(2)) && (ISNUM(3)||ISCHAR(3)||ISNIL(3)) )
    {
#endif
      auto ptr = new QByteArray( obj->toPercentEncoding( ISNIL(1)? QByteArray() : *(QByteArray *) Qt5xHb::itemGetPtr(1), ISNIL(2)? QByteArray() : *(QByteArray *) Qt5xHb::itemGetPtr(2), OPCHAR(3,'%') ) );
      Qt5xHb::createReturnClass( ptr, "QBYTEARRAY", true );
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    }
    else
...
void QByteArray_fromBase642()
{
  ...
  auto ptr = new QByteArray( QByteArray::fromBase64( *PQBYTEARRAY(1), (QByteArray::Base64Options) hb_parni(2) ) );
  Qt5xHb::createReturnClass( ptr, "QBYTEARRAY", true );
#endif
}
...
{
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  if( ISBETWEEN(1,2) && ISQBYTEARRAY(1) && (ISNUM(2)||ISCHAR(2)||ISNIL(2)) )
  {
#endif
...
HB_FUNC_STATIC( QBYTEARRAY_NUMBER )
{
  ...
  else if( ISBETWEEN(1,3) && ISNUM(1) && (ISNUM(2)||ISCHAR(2)||ISNIL(2)) && (ISNUM(3)||ISNIL(3)) )
  {
...
void QByteArray_compare1()
{
  ...
  if( obj != nullptr )
  {
    RINT( obj->compare( PCONSTCHAR(1), ISNIL(2)? (Qt::CaseSensitivity) Qt::CaseSensitive : (Qt::CaseSensitivity) hb_parni(2) ) );
  }
#endif
}
...
void QByteArray_compare2()
{
  ...
  if( obj != nullptr )
  {
    RINT( obj->compare( *PQBYTEARRAY(1), ISNIL(2)? (Qt::CaseSensitivity) Qt::CaseSensitive : (Qt::CaseSensitivity) hb_parni(2) ) );
  }
#endif
}
