...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QSequentialAnimationGroup *>(Qt5xHb::getQObjectPointerFromSelfItem())
  ...
  if (sender != nullptr) {
    ...
    if (ISNUMPAR(1) && ISBLOCKORSYMBOL(1)) {
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection = QObject::connect(sender, &QSequentialAnimationGroup::currentAnimationChanged,
                                           [sender, indexOfCodeBlock](QAbstractAnimation *arg1) {
                                             auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);

                                             if (cb != nullptr) {
                                               auto pSender =
                                                   Qt5xHb::Signals_return_qobject(sender, "QSEQUENTIALANIMATIONGROUP");
