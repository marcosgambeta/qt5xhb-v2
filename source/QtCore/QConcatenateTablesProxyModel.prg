...
#define GET_PTR_FROM_SELF(p)                                                                                           \
  auto p = qobject_cast<QConcatenateTablesProxyModel *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
      RBOOL(obj->canDropMimeData(PQMIMEDATA(1), PQT_DROPACTION(2), PINT(3), PINT(4), *PQMODELINDEX(5)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        ...
        THROW_ERROR_1001("QABSTRACTITEMMODEL");
      }
