...
HB_FUNC_STATIC( QCONCATENATETABLESPROXYMODEL_CANDROPMIMEDATA )
{
  ...
  if( obj != nullptr )
  {
    ...
    {
#endif
      RBOOL( obj->canDropMimeData( PQMIMEDATA( 1 ), static_cast<Qt::DropAction>( hb_parni( 2 ) ), PINT( 3 ), PINT( 4 ), *PQMODELINDEX( 5 ) ) );
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
    ...
    if( ISNUMPAR( 0 ) )
    {
      ...
      if( pDynSym )
      {
        for( auto i = 0; i < list.count(); i++ )
        {
          ...
          hb_itemPutPtr( pItem, static_cast< QAbstractItemModel * >( list[ i ] ) );
