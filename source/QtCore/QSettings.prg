...
{
  if (ISBETWEEN(1, 3) && ISQSTRING(1) && ISQSTRINGORNIL(2) && ISQOBJECTORNIL(3)) {
    // QSettings(const QString &organization, const QString &application = QString(), QObject *parent = nullptr)
    auto obj = new QSettings(PQSTRING(1), OPQSTRING(2, QString()), OPQOBJECT(3, nullptr));
    Qt5xHb::returnNewObject(obj, false);
  } else if (ISBETWEEN(2, 4) && HB_ISNUM(1) && ISQSTRING(2) && ISQSTRINGORNIL(3) && ISQOBJECTORNIL(4)) {
    ...
    Qt5xHb::returnNewObject(obj, false);
  } else if (ISBETWEEN(3, 5) && HB_ISNUM(1) && HB_ISNUM(2) && ISQSTRING(3) && ISQSTRINGORNIL(4) && ISQOBJECTORNIL(5)) {
...
#endif
      RQVARIANT(obj->value(PQSTRING(1), HB_ISNIL(2) ? QVariant() : *PQVARIANT(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QSETTINGS_SETDEFAULTFORMAT)
{
  ...
  if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
    QSettings::setDefaultFormat(PQSETTINGS_FORMAT(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  } else {
    THROW_ERROR_3012();
  }
