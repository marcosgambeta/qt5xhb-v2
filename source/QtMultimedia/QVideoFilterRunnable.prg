...
HB_FUNC_STATIC( QVIDEOFILTERRUNNABLE_NEWFROM )
{
  PHB_ITEM self = hb_stackSelfItem();
...
HB_FUNC_STATIC( QVIDEOFILTERRUNNABLE_NEWFROMOBJECT )
{
  HB_FUNC_EXEC( QVIDEOFILTERRUNNABLE_NEWFROM );
}

HB_FUNC_STATIC( QVIDEOFILTERRUNNABLE_NEWFROMPOINTER )
{
  HB_FUNC_EXEC( QVIDEOFILTERRUNNABLE_NEWFROM );
}

HB_FUNC_STATIC( QVIDEOFILTERRUNNABLE_SELFDESTRUCTION )
{
  hb_retl( static_cast< bool >( hb_itemGetL( hb_objSendMsg( hb_stackSelfItem(), "SELF_DESTRUCTION", 0 ) ) ) );
}

HB_FUNC_STATIC( QVIDEOFILTERRUNNABLE_SETSELFDESTRUCTION )
{
  PHB_ITEM self = hb_stackSelfItem();
