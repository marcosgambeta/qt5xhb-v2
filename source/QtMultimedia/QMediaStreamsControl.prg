...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QMediaStreamsControl *>(Qt5xHb::getQObjectPointerFromSelfItem())
  ...
  if (sender != nullptr) {
    ...
    if (ISNUMPAR(1) && ISBLOCKORSYMBOL(1)) {
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection =
            QObject::connect(sender, &QMediaStreamsControl::activeStreamsChanged, [sender, indexOfCodeBlock]() {
...
HB_FUNC_STATIC(QMEDIASTREAMSCONTROL_ONSTREAMSCHANGED)
{
  ...
  if (sender != nullptr) {
    ...
    if (ISNUMPAR(1) && ISBLOCKORSYMBOL(1)) {
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection = QObject::connect(sender, &QMediaStreamsControl::streamsChanged, [sender, indexOfCodeBlock]() {
          auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);
