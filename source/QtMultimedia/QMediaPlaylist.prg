...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QMediaPlaylist *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
      obj->setPlaybackMode(PQMEDIAPLAYLIST_PLAYBACKMODE(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
{
  if (ISNUMPAR(2) && HB_ISNUM(1) && ISQMEDIACONTENT(2)) {
