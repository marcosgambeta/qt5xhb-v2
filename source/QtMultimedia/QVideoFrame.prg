...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QVideoFrame *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QVIDEOFRAME_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    auto obj = new QVideoFrame(PINT(1), *PQSIZE(2), PINT(3), PQVIDEOFRAME_PIXELFORMAT(4));
    Qt5xHb::returnNewObject(obj, true);
...
#endif
      RBOOL(obj->map(PQABSTRACTVIDEOBUFFER_MAPMODE(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QVIDEOFRAME_SETFIELDTYPE)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setFieldType(PQVIDEOFRAME_FIELDTYPE(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QVIDEOFRAME_IMAGEFORMATFROMPIXELFORMAT)
{
  ...
  if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
    RENUM(QVideoFrame::imageFormatFromPixelFormat(PQVIDEOFRAME_PIXELFORMAT(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  } else {
    hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
  }
...
HB_FUNC_STATIC(QVIDEOFRAME_PIXELFORMATFROMIMAGEFORMAT)
{
  ...
  if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
    RENUM(QVideoFrame::pixelFormatFromImageFormat(PQIMAGE_FORMAT(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  } else {
    hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
  }
