...
{
  auto sender = qobject_cast<QCameraImageCaptureControl *>(Qt5xHb::getQObjectPointerFromSelfItem());

  auto result = false;

  if (sender != nullptr)
  {
    auto indexOfSignal = sender->metaObject()->indexOfSignal("error(int,int,QString)");
    ...
    if (hb_pcount() == 1 && (HB_ISBLOCK(1) || HB_ISSYMBOL(1)))
    {
      ...
      {
        auto connection = QObject::connect(sender, &QCameraImageCaptureControl::error,
                                           [sender, indexOfCodeBlock](int arg1, int arg2, const QString &arg3) {
                                             auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);

                                             if (cb != nullptr)
                                             {
                                               auto pSender =
                                                   Qt5xHb::Signals_return_qobject(sender, "QCAMERAIMAGECAPTURECONTROL");
...
HB_FUNC_STATIC(QCAMERAIMAGECAPTURECONTROL_ONIMAGEAVAILABLE)
{
  ...
  if (sender != nullptr)
  {
    ...
    if (hb_pcount() == 1 && (HB_ISBLOCK(1) || HB_ISSYMBOL(1)))
    {
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock))
      {
        auto connection = QObject::connect(sender, &QCameraImageCaptureControl::imageAvailable,
...
HB_FUNC_STATIC(QCAMERAIMAGECAPTURECONTROL_ONIMAGECAPTURED)
{
  ...
  if (sender != nullptr)
  {
    ...
    if (hb_pcount() == 1 && (HB_ISBLOCK(1) || HB_ISSYMBOL(1)))
    {
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock))
      {
        auto connection = QObject::connect(sender, &QCameraImageCaptureControl::imageCaptured,
                                           [sender, indexOfCodeBlock](int arg1, const QImage &arg2) {
                                             auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);
...
HB_FUNC_STATIC(QCAMERAIMAGECAPTURECONTROL_ONIMAGEEXPOSED)
{
  ...
  if (sender != nullptr)
  {
    ...
    if (hb_pcount() == 1 && (HB_ISBLOCK(1) || HB_ISSYMBOL(1)))
    {
      ...
      {
        auto connection =
            QObject::connect(sender, &QCameraImageCaptureControl::imageExposed, [sender, indexOfCodeBlock](int arg1) {
              auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);

              if (cb != nullptr)
              {
                auto pSender = Qt5xHb::Signals_return_qobject(sender, "QCAMERAIMAGECAPTURECONTROL");
                auto pArg1 = hb_itemPutNI(nullptr, arg1);
...
HB_FUNC_STATIC(QCAMERAIMAGECAPTURECONTROL_ONIMAGEMETADATAAVAILABLE)
{
  ...
  if (sender != nullptr)
  {
    ...
    if (hb_pcount() == 1 && (HB_ISBLOCK(1) || HB_ISSYMBOL(1)))
    {
      ...
      {
        auto connection =
            QObject::connect(sender, &QCameraImageCaptureControl::imageMetadataAvailable,
                             [sender, indexOfCodeBlock](int arg1, const QString &arg2, const QVariant &arg3) {
                               auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);
    ...
    if (hb_pcount() == 1 && (HB_ISBLOCK(1) || HB_ISSYMBOL(1)))
    {
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock))
      {
        auto connection = QObject::connect(
            sender, &QCameraImageCaptureControl::imageSaved, [sender, indexOfCodeBlock](int arg1, const QString &arg2) {
              auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);
...
HB_FUNC_STATIC(QCAMERAIMAGECAPTURECONTROL_ONREADYFORCAPTURECHANGED)
{
  ...
  if (sender != nullptr)
  {
    ...
    if (hb_pcount() == 1 && (HB_ISBLOCK(1) || HB_ISSYMBOL(1)))
    {
      ...
      {
        auto connection = QObject::connect(
            sender, &QCameraImageCaptureControl::readyForCaptureChanged, [sender, indexOfCodeBlock](bool arg1) {
              auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);
