...
void QXmlQuery_new4()
{
  auto obj = new QXmlQuery( (QXmlQuery::QueryLanguage) hb_parni(1), HB_ISNIL(2)? QXmlNamePool() : *(QXmlNamePool *) Qt5xHb::itemGetPtr(2) );
  Qt5xHb::returnNewObject( obj, true );
}
...
{
  auto obj = (QXmlQuery *) Qt5xHb::itemGetPtrStackSelfItem();
