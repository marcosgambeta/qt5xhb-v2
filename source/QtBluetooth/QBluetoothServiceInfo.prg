...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QBluetoothServiceInfo *>(Qt5xHb::itemGetPtrStackSelfItem())
...
#endif
      RBOOL(obj->registerService(HB_ISNIL(1) ? QBluetoothAddress() : *PQBLUETOOTHADDRESS(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
