...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QBluetoothDeviceInfo *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QBLUETOOTHDEVICEINFO_SETSERVICEUUIDS)
{
  if (ISNUMPAR(2) && HB_ISARRAY(1) && HB_ISNUM(2)) {
    ...
    if (obj != nullptr) {
      ...
      obj->setServiceUuids(par1, PQBLUETOOTHDEVICEINFO_DATACOMPLETENESS(2));
    }
...
HB_FUNC_STATIC(QBLUETOOTHDEVICEINFO_SETCORECONFIGURATIONS)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setCoreConfigurations(PQBLUETOOTHDEVICEINFO_CORECONFIGURATIONS(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QBLUETOOTHDEVICEINFO_DEVICEUUID)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQBLUETOOTHUUID(obj->deviceUuid());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
