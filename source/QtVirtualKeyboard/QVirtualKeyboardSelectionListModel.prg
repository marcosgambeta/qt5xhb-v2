...
#define GET_PTR_FROM_SELF(p)                                                                                           \
  auto p = qobject_cast<QVirtualKeyboardSelectionListModel *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
      obj->setDataSource(PQVIRTUALKEYBOARDABSTRACTINPUTMETHOD(1), PQVIRTUALKEYBOARDSELECTIONLISTMODEL_TYPE(2));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
