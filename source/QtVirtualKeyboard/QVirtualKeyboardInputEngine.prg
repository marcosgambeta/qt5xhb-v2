...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONVIRTUALKEYCLICKED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("virtualKeyClicked(Qt::Key,QString,Qt::KeyboardModifiers,bool)");
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals3_connection( sender, index ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals3_return_qobject ( (QObject *) sender, "QVIRTUALKEYBOARDINPUTENGINE" );
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONACTIVEKEYCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("activeKeyChanged(Qt::Key)");
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONPREVIOUSKEYCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("previousKeyChanged(Qt::Key)");
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONINPUTMETHODCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("inputMethodChanged()");
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONINPUTMETHODRESET )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("inputMethodReset()");
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONINPUTMETHODUPDATE )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("inputMethodUpdate()");
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONINPUTMODESCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("inputModesChanged()");
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONINPUTMODECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("inputModeChanged()");
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONPATTERNRECOGNITIONMODESCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("patternRecognitionModesChanged()");
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONWORDCANDIDATELISTMODELCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("wordCandidateListModelChanged()");
...
HB_FUNC_STATIC( QVIRTUALKEYBOARDINPUTENGINE_ONWORDCANDIDATELISTVISIBLEHINTCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("wordCandidateListVisibleHintChanged()");
