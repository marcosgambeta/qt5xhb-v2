...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QGeoRectangle *>(Qt5xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QGEORECTANGLE_BOTTOMLEFT)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQGEOCOORDINATE(obj->bottomLeft());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QGEORECTANGLE_BOTTOMRIGHT)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQGEOCOORDINATE(obj->bottomRight());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QGEORECTANGLE_TRANSLATED)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(2) && HB_ISNUM(1) && HB_ISNUM(2)) {
#endif
      RQGEORECTANGLE(obj->translated(PDOUBLE(1), PDOUBLE(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QGEORECTANGLE_UNITED)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && ISQGEORECTANGLE(1)) {
#endif
      RQGEORECTANGLE(obj->united(*PQGEORECTANGLE(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
