    ...
    if( hb_pcount() == 1 )
    {
      if( Signals5_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals5_return_qobject( (QObject *) sender, "QWEBSOCKETSERVER" );
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals5_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          {
            PHB_ITEM pSender = Signals5_return_qobject( (QObject *) sender, "QWEBSOCKETSERVER" );
            PHB_ITEM pArg1 = Signals5_return_object( (void *) arg1, "QWEBSOCKETCORSAUTHENTICATOR" );
            hb_vmEvalBlockV( cb, 2, pSender, pArg1 );
            hb_itemRelease( pSender );
            hb_itemRelease( pArg1 );
          }
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals5_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          {
            PHB_ITEM pSender = Signals5_return_qobject( (QObject *) sender, "QWEBSOCKETSERVER" );
            PHB_ITEM pArg1 = Signals5_return_object( (void *) &arg1, "QSSLERROR" );
            hb_vmEvalBlockV( cb, 2, pSender, pArg1 );
            hb_itemRelease( pSender );
            hb_itemRelease( pArg1 );
          }
