...
HB_FUNC_STATIC( QSSLKEY_NEW )
{
  ...
  else if( ISBETWEEN(2,5) && ISQBYTEARRAY(1) && ISNUM(2) && (ISNUM(3)||ISNIL(3)) && (ISNUM(4)||ISNIL(4)) && ISOPTQBYTEARRAY(5) )
  {
    QSslKey_new2();
  }
  else if( ISBETWEEN(2,5) && ISQIODEVICE(1) && ISNUM(2) && (ISNUM(3)||ISNIL(3)) && (ISNUM(4)||ISNIL(4)) && ISOPTQBYTEARRAY(5) )
  {
    QSslKey_new3();
  }
