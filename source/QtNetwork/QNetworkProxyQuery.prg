...
HB_FUNC_STATIC(QNETWORKPROXYQUERY_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    Qt5xHb::returnNewObject(obj, true);
  } else if (ISBETWEEN(2, 4) && ISQSTRING(1) && HB_ISNUM(2) && ISQSTRINGORNIL(3) && ISNUMORNIL(4)) {
    ...
    Qt5xHb::returnNewObject(obj, true);
  } else if (ISBETWEEN(1, 3) && HB_ISNUM(1) && ISQSTRINGORNIL(2) && ISNUMORNIL(3)) {
    ...
    Qt5xHb::returnNewObject(obj, true);
  } else if (ISBETWEEN(3, 5) && ISQNETWORKCONFIGURATION(1) && ISQSTRING(2) && HB_ISNUM(3) && ISQSTRINGORNIL(4) &&
             ISNUMORNIL(5)) {
    ...
    Qt5xHb::returnNewObject(obj, true);
  } else if (ISBETWEEN(2, 4) && ISQNETWORKCONFIGURATION(1) && HB_ISNUM(2) && ISQSTRINGORNIL(3) && ISNUMORNIL(4)) {
