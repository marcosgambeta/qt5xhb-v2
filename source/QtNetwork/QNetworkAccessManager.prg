    ...
    if( hb_pcount() == 1 )
    {
      if( Signals_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals_return_qobject( (QObject *) sender, "QNETWORKACCESSMANAGER" );
            PHB_ITEM pArg1 = Signals_return_object( (void *) &arg1, "QNETWORKPROXY" );
            PHB_ITEM pArg2 = Signals_return_object( (void *) arg2, "QAUTHENTICATOR" );
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          {
            PHB_ITEM pSender = Signals_return_qobject( (QObject *) sender, "QNETWORKACCESSMANAGER" );
            PHB_ITEM pArg1 = Signals_return_qobject( (QObject *) arg1, "QNETWORKREPLY" );
            PHB_ITEM pArg2 = Signals_return_object( (void *) arg2, "QAUTHENTICATOR" );
            hb_vmEvalBlockV( cb, 3, pSender, pArg1, pArg2 );
            hb_itemRelease( pSender );
            hb_itemRelease( pArg1 );
      ...
      if( Signals_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals_return_qobject( (QObject *) sender, "QNETWORKACCESSMANAGER" );
            PHB_ITEM pArg1 = Signals_return_qobject( (QObject *) arg1, "QNETWORKREPLY" );
            PHB_ITEM pArg2 = Signals_return_object( (void *) arg2, "QSSLPRESHAREDKEYAUTHENTICATOR" );
            hb_vmEvalBlockV( cb, 3, pSender, pArg1, pArg2 );
            hb_itemRelease( pSender );
            hb_itemRelease( pArg1 );
            hb_itemRelease( pArg2 );
