...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QDnsLookup *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
      obj->setType(PQDNSLOOKUP_TYPE(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        for (const auto &item : list) {
          ...
          auto pItem = hb_itemPutPtr(nullptr, new QDnsDomainNameRecord(item));
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        for (const auto &item : list) {
          ...
          auto pObject = hb_itemNew(nullptr);
          hb_itemCopy(pObject, hb_stackReturnItem());
          auto pItem = hb_itemPutPtr(nullptr, new QDnsHostAddressRecord(item));
          hb_objSendMsg(pObject, "_POINTER", 1, pItem);
          hb_itemRelease(pItem);
          auto pDestroy = hb_itemPutL(nullptr, true);
          hb_objSendMsg(pObject, "_SELF_DESTRUCTION", 1, pDestroy);
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        for (const auto &item : list) {
          ...
          auto pObject = hb_itemNew(nullptr);
          hb_itemCopy(pObject, hb_stackReturnItem());
          auto pItem = hb_itemPutPtr(nullptr, new QDnsMailExchangeRecord(item));
          hb_objSendMsg(pObject, "_POINTER", 1, pItem);
          hb_itemRelease(pItem);
          auto pDestroy = hb_itemPutL(nullptr, true);
          hb_objSendMsg(pObject, "_SELF_DESTRUCTION", 1, pDestroy);
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        for (const auto &item : list) {
          ...
          auto pObject = hb_itemNew(nullptr);
          hb_itemCopy(pObject, hb_stackReturnItem());
          auto pItem = hb_itemPutPtr(nullptr, new QDnsServiceRecord(item));
          hb_objSendMsg(pObject, "_POINTER", 1, pItem);
          hb_itemRelease(pItem);
          auto pDestroy = hb_itemPutL(nullptr, true);
          hb_objSendMsg(pObject, "_SELF_DESTRUCTION", 1, pDestroy);
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        for (const auto &item : list) {
          ...
          auto pObject = hb_itemNew(nullptr);
          hb_itemCopy(pObject, hb_stackReturnItem());
          auto pItem = hb_itemPutPtr(nullptr, new QDnsTextRecord(item));
          hb_objSendMsg(pObject, "_POINTER", 1, pItem);
          hb_itemRelease(pItem);
          auto pDestroy = hb_itemPutL(nullptr, true);
          hb_objSendMsg(pObject, "_SELF_DESTRUCTION", 1, pDestroy);
    ...
    if (ISNUMPAR(1) && ISBLOCKORSYMBOL(1)) {
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection = QObject::connect(sender, &QDnsLookup::finished, [sender, indexOfCodeBlock]() {
          ...
          if (cb != nullptr) {
            auto pSender = Qt5xHb::Signals_return_qobject(sender, "QDNSLOOKUP");
      ...
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection = QObject::connect(
            sender, &QDnsLookup::nameserverChanged, [sender, indexOfCodeBlock](const QHostAddress &arg1) {
              ...
              if (cb != nullptr) {
                auto pSender = Qt5xHb::Signals_return_qobject(sender, "QDNSLOOKUP");
                auto pArg1 = Qt5xHb::Signals_return_object((void *)&arg1, "QHOSTADDRESS");
                hb_vmEvalBlockV(cb, 2, pSender, pArg1);
                hb_itemRelease(pSender);
                hb_itemRelease(pArg1);
              }
