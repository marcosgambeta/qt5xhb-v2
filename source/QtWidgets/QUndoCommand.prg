...
{
  auto obj = new QUndoCommand( HB_ISNIL(1)? nullptr : (QUndoCommand *) Qt5xHb::itemGetPtr(1) );
...
{
  auto obj = new QUndoCommand( PQSTRING(1), HB_ISNIL(2)? nullptr : (QUndoCommand *) Qt5xHb::itemGetPtr(2) );
  Qt5xHb::returnNewObject( obj, false );
}
