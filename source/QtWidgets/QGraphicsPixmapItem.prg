...
#define GET_PTR_FROM_SELF(p) auto p = static_cast<QGraphicsPixmapItem *>(Qt5xHb::itemGetPtrStackSelfItem())
...
#endif
      obj->setShapeMode(PQGRAPHICSPIXMAPITEM_SHAPEMODE(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QGRAPHICSPIXMAPITEM_SETTRANSFORMATIONMODE)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setTransformationMode(PQT_TRANSFORMATIONMODE(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
