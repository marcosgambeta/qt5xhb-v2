...
HB_FUNC_STATIC(QMESSAGEBOX_NEW)
{
  ...
  } else if (ISBETWEEN(3, 6) && HB_ISNUM(1) && ISQSTRING(2) && ISQSTRING(3) && ISNUMORNIL(4) && ISQWIDGETORNIL(5) &&
             ISNUMORNIL(6)) {
...
HB_FUNC_STATIC(QMESSAGEBOX_ADDBUTTON)
{
  if (ISNUMPAR(2) && ISQABSTRACTBUTTON(1) && HB_ISNUM(2)) {
    ...
    if (obj != nullptr) {
      auto ptr = obj->addButton(PQSTRING(1), PQMESSAGEBOX_BUTTONROLE(2));
    ...
    if (obj != nullptr) {
      auto ptr = obj->addButton(PQMESSAGEBOX_STANDARDBUTTON(1));
      Qt5xHb::createReturnQWidgetClass(ptr, "QPUSHBUTTON");
    }
  } else {
    THROW_ERROR_3012();
...
#endif
      auto ptr = obj->button(PQMESSAGEBOX_STANDARDBUTTON(1));
...
HB_FUNC_STATIC(QMESSAGEBOX_SETICON)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setIcon(PQMESSAGEBOX_ICON(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QMESSAGEBOX_SETSTANDARDBUTTONS)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setStandardButtons(PQMESSAGEBOX_STANDARDBUTTONS(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
{
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  if (ISNUMPAR(3) && ISQWIDGET(1) && ISQSTRING(2) && ISQSTRING(3)) {
#endif
...
{
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  if (ISBETWEEN(1, 2) && ISQWIDGET(1) && ISQSTRINGORNIL(2)) {
#endif
...
{
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  if (ISBETWEEN(3, 5) && ISQWIDGET(1) && ISQSTRING(2) && ISQSTRING(3) && ISNUMORNIL(4) && ISNUMORNIL(5)) {
#endif
...
HB_FUNC_STATIC(QMESSAGEBOX_STANDARDICON)
{
  ...
  if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
    RQPIXMAP(QMessageBox::standardIcon(PQMESSAGEBOX_ICON(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  } else {
    THROW_ERROR_3012();
  }
