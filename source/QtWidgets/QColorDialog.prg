...
{
  auto obj = new QColorDialog( HB_ISOBJECT(1)? *(QColor *) Qt5xHb::itemGetPtr(1) : QColor(hb_parc(1)), OPQWIDGET(2,nullptr) );
  Qt5xHb::returnNewObject( obj, false );
}
...
HB_FUNC_STATIC( QCOLORDIALOG_GETCOLOR )
{
  ...
  {
#endif
    auto ptr = new QColor( QColorDialog::getColor( HB_ISNIL(1)? Qt::white : *(QColor *) Qt5xHb::itemGetPtr(1), OPQWIDGET(2,nullptr), OPQSTRING(3,QString()), HB_ISNIL(4)? (QColorDialog::ColorDialogOptions) 0 : (QColorDialog::ColorDialogOptions) hb_parni(4) ) );
    Qt5xHb::createReturnClass( ptr, "QCOLOR", true );
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  }
  else
