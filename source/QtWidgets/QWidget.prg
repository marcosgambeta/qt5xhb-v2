...
HB_FUNC_STATIC( QWIDGET_NEW )
{
  ...
  {
    auto obj = new QWidget( OPQWIDGET(1,nullptr), HB_ISNIL(2)? (Qt::WindowFlags) 0 : (Qt::WindowFlags) hb_parni(2) );
...
HB_FUNC_STATIC( QWIDGET_GRAB )
{
  ...
  if( obj != nullptr )
  {
    ...
    {
#endif
      auto ptr = new QPixmap( obj->grab( HB_ISNIL(1)? QRect(QPoint(0, 0), QSize(-1, -1)) : *(QRect *) Qt5xHb::itemGetPtr(1) ) );
...
HB_FUNC_STATIC( QWIDGET_CREATEWINDOWCONTAINER )
{
  ...
  {
#endif
    QWidget * ptr = QWidget::createWindowContainer( PQWINDOW(1), OPQWIDGET(2,nullptr), HB_ISNIL(3)? (Qt::WindowFlags) 0 : (Qt::WindowFlags) hb_parni(3) );
    Qt5xHb::createReturnQWidgetClass( ptr, "QWIDGET" );
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  }
  else
