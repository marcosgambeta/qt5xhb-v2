...
HB_FUNC_STATIC( QTREEVIEW_ONCOLLAPSED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("collapsed(QModelIndex)");
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals3_connection( sender, index ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals3_return_qobject ( (QObject *) sender, "QTREEVIEW" );
...
HB_FUNC_STATIC( QTREEVIEW_ONEXPANDED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("expanded(QModelIndex)");
