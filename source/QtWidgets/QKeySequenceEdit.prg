...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,2,0))
  auto obj = (QKeySequenceEdit *) Qt5xHb::itemGetPtrStackSelfItem();
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals5_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals5_return_qobject( (QObject *) sender, "QKEYSEQUENCEEDIT" );
...
HB_FUNC_STATIC( QKEYSEQUENCEEDIT_ONKEYSEQUENCECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("keySequenceChanged(QKeySequence)");
    int indexOfCodeBlock = -1;
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals5_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          {
            PHB_ITEM pSender = Signals5_return_qobject( (QObject *) sender, "QKEYSEQUENCEEDIT" );
            PHB_ITEM pArg1 = Signals5_return_object( (void *) &arg1, "QKEYSEQUENCE" );
