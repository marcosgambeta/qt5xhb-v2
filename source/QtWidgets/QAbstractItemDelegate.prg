...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QAbstractItemDelegate *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
// virtual bool helpEvent(QHelpEvent *event, QAbstractItemView *view, const QStyleOptionViewItem &option, const
// QModelIndex &index)
...
#endif
    RQSTRING(QAbstractItemDelegate::elidedText(*PQFONTMETRICS(1), PINT(2), PQT_TEXTELIDEMODE(3), PQSTRING(4)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
  } else {
    hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
  }
      ...
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection =
            QObject::connect(sender, &QAbstractItemDelegate::closeEditor,
                             [sender, indexOfCodeBlock](QWidget *arg1, QAbstractItemDelegate::EndEditHint arg2) {
                               auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);

                               if (cb != nullptr) {
                                 auto pSender = Qt5xHb::Signals_return_qobject(sender, "QABSTRACTITEMDELEGATE");
