    ...
    if( hb_pcount() == 1 )
    {
      if( Signals_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals_return_qobject( (QObject *) sender, "QLISTWIDGET" );
            PHB_ITEM pArg1 = Signals_return_object( (void *) arg1, "QLISTWIDGETITEM" );
            PHB_ITEM pArg2 = Signals_return_object( (void *) arg2, "QLISTWIDGETITEM" );
