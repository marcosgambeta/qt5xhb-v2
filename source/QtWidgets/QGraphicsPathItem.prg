...
{
  auto obj = new QGraphicsPathItem( HB_ISNIL(1)? nullptr : (QGraphicsItem *) Qt5xHb::itemGetPtr(1) );
...
{
  auto obj = new QGraphicsPathItem( *PQPAINTERPATH(1), HB_ISNIL(2)? nullptr : (QGraphicsItem *) Qt5xHb::itemGetPtr(2) );
  Qt5xHb::returnNewObject( obj, true );
}
...
{
  auto obj = (QGraphicsPathItem *) Qt5xHb::itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QGRAPHICSPATHITEM_PATH )
{
  ...
  if( obj != nullptr )
  {
    ...
    {
#endif
      auto ptr = new QPainterPath( obj->path() );
