...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,7,0))
  auto obj = qobject_cast< QAbstractAxis * >( Qt5xHb::getQObjectPointerFromSelfItem() );
...
HB_FUNC_STATIC( QABSTRACTAXIS_SETMINORGRIDLINECOLOR )
{
  ...
  if( obj != nullptr )
  {
    ...
    {
#endif
      obj->setMinorGridLineColor( HB_ISOBJECT( 1 ) ? *static_cast< QColor * >( Qt5xHb::itemGetPtr( 1 ) ) : QColor( hb_parc( 1 ) ) );
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
    ...
    if( hb_pcount() == 1 )
    {
      if( Qt5xHb::Signals_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Qt5xHb::Signals_return_qobject( (QObject *) sender, "QABSTRACTAXIS" );
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONGRIDLINEPENCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("gridLinePenChanged(QPen)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONGRIDVISIBLECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("gridVisibleChanged(bool)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONLABELSANGLECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("labelsAngleChanged(int)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONLABELSBRUSHCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("labelsBrushChanged(QBrush)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONLABELSCOLORCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("labelsColorChanged(QColor)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONLABELSFONTCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("labelsFontChanged(QFont)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONLABELSVISIBLECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("labelsVisibleChanged(bool)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONLINEPENCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("linePenChanged(QPen)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONLINEVISIBLECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("lineVisibleChanged(bool)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONMINORGRIDLINECOLORCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("minorGridLineColorChanged(QColor)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONMINORGRIDLINEPENCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("minorGridLinePenChanged(QPen)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONMINORGRIDVISIBLECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("minorGridVisibleChanged(bool)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONREVERSECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("reverseChanged(bool)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONSHADESBORDERCOLORCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("shadesBorderColorChanged(QColor)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONSHADESBRUSHCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("shadesBrushChanged(QBrush)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONSHADESCOLORCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("shadesColorChanged(QColor)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONSHADESPENCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("shadesPenChanged(QPen)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONSHADESVISIBLECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("shadesVisibleChanged(bool)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONTITLEBRUSHCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("titleBrushChanged(QBrush)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONTITLEFONTCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("titleFontChanged(QFont)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONTITLETEXTCHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("titleTextChanged(QString)");
    int indexOfCodeBlock = -1;
...
HB_FUNC_STATIC( QABSTRACTAXIS_ONTITLEVISIBLECHANGED )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("titleVisibleChanged(bool)");
    int indexOfCodeBlock = -1;
