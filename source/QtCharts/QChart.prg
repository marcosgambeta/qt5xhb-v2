...
HB_FUNC_STATIC( QCHART_NEW )
{
  ...
  {
    auto obj = new QChart ( ISNIL(1)? nullptr : (QGraphicsItem *) _qt5xhb_itemGetPtr(1), ISNIL(2)? (Qt::WindowFlags) Qt::WindowFlags() : (Qt::WindowFlags) hb_parni(2) );
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,7,0))
  QChart * sender = (QChart *) _qt5xhb_itemGetPtrStackSelfItem();
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals4_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals4_return_qobject ( (QObject *) sender, "QCHART" );
