...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QAbstractBarSeries *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(QABSTRACTBARSERIES_SETLABELSPOSITION)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setLabelsPosition(PQABSTRACTBARSERIES_LABELSPOSITION(1));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
      ...
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection = QObject::connect(sender, &QAbstractBarSeries::labelsPositionChanged,
                                           [sender, indexOfCodeBlock](QAbstractBarSeries::LabelsPosition arg1) {
                                             ...
                                             if (cb != nullptr) {
                                               auto pSender =
                                                   Qt5xHb::Signals_return_qobject(sender, "QABSTRACTBARSERIES");
