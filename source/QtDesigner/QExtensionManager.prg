...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QExtensionManager *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(QEXTENSIONMANAGER_REGISTEREXTENSIONS)
{
  ...
  if (obj != nullptr) {
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    if (ISBETWEEN(1, 2) && ISQABSTRACTEXTENSIONFACTORY(1) && ISQSTRINGORNIL(2)) {
#endif
