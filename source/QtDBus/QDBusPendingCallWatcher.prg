    ...
    if( hb_pcount() == 1 )
    {
      if( Signals4_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals4_return_qobject ( (QObject *) sender, "QDBUSPENDINGCALLWATCHER" );
            PHB_ITEM pArg1 = Signals4_return_qobject( (QObject *) arg1, "QDBUSPENDINGCALLWATCHER" );
