    ...
    if( ISNUMPAR( 0 ) )
    {
      ...
      if( pDynSym )
      {
        for( auto i = 0; i < list.count(); i++ )
        {
          ...
          hb_itemPutPtr( pItem, static_cast< QGeoLocation * >( new QGeoLocation( list[ i ] ) ) );
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,4,0))
  auto sender = (QGeoCodeReply *) Qt5xHb::itemGetPtrStackSelfItem();
    ...
    if( hb_pcount() == 1 )
    {
      if( Qt5xHb::Signals_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Qt5xHb::Signals_return_qobject( (QObject *) sender, "QGEOCODEREPLY" );
...
HB_FUNC_STATIC( QGEOCODEREPLY_ONERROR )
{
  ...
  if( sender != nullptr )
  {
    int indexOfSignal = sender->metaObject()->indexOfSignal("error(QGeoCodeReply::Error,QString)");
    int indexOfCodeBlock = -1;
