  ...
  if( hb_pcount() == 1 )
  {
    ...
    if( sender )
    {
      if( Signals2_connection( sender, "finished(QGeoCodeReply*)" ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, &QGeoCodingManagerEngine::finished, [sender](QGeoCodeReply* arg1) {
  ...
  if( hb_pcount() == 1 )
  {
    ...
    if( sender )
    {
      if( Signals2_connection( sender, "error(QGeoCodeReply*,QGeoCodeReply::Error,QString)" ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, &QGeoCodingManagerEngine::error, [sender](QGeoCodeReply* arg1, QGeoCodeReply::Error arg2, QString arg3) {
