...
HB_FUNC_STATIC( QGEOCODINGMANAGERENGINE_ONFINISHED )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("finished(QGeoCodeReply*)");
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals3_connection( sender, index ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals3_return_qobject ( (QObject *) sender, "QGEOCODINGMANAGERENGINE" );
            PHB_ITEM pArg1 = Signals3_return_qobject( (QObject *) arg1, "QGEOCODEREPLY" );
...
HB_FUNC_STATIC( QGEOCODINGMANAGERENGINE_ONERROR )
{
  ...
  if( sender != nullptr )
  {
    int index = sender->metaObject()->indexOfSignal("error(QGeoCodeReply*,QGeoCodeReply::Error,QString)");
