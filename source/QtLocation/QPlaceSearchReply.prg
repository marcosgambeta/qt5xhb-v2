    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        for (const auto &item : list) {
          ...
          auto pItem = hb_itemPutPtr(nullptr, new QPlaceSearchResult(item));
        ...
        hb_errRT_BASE(EG_NOFUNC, 1001, nullptr, "QPLACESEARCHRESULT", HB_ERR_ARGS_BASEPARAMS);
      }
...
HB_FUNC_STATIC(QPLACESEARCHREPLY_REQUEST)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQPLACESEARCHREQUEST(obj->request());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QPLACESEARCHREPLY_PREVIOUSPAGEREQUEST)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQPLACESEARCHREQUEST(obj->previousPageRequest());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QPLACESEARCHREPLY_NEXTPAGEREQUEST)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQPLACESEARCHREQUEST(obj->nextPageRequest());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
