...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<Q3DScatter *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(Q3DSCATTER_NEW)
{
  ...
  if (ISBETWEEN(0, 2) && ISQSURFACEFORMATORNIL(1) && ISQWINDOWORNIL(2)) {
    auto obj = new Q3DScatter(HB_ISNIL(1) ? nullptr : PQSURFACEFORMAT(1), OPQWINDOW(2, nullptr));
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        ...
        THROW_ERROR_1001("QSCATTER3DSERIES");
      }
