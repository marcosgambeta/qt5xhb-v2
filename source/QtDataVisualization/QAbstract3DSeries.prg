...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QAbstract3DSeries *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
      obj->setBaseColor(HB_ISOBJECT(1) ? *PQCOLOR(1) : QColor(hb_parc(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, nullptr, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
      ...
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection =
            QObject::connect(sender, &QAbstract3DSeries::multiHighlightGradientChanged,
                             [sender, indexOfCodeBlock](const QLinearGradient &arg1) {
                               auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);
