...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QCustom3DVolume *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
      obj->setSliceFrameColor(HB_ISOBJECT(1) ? *PQCOLOR(1) : QColor(hb_parc(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QCUSTOM3DVOLUME_SLICEFRAMEWIDTHS)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQVECTOR3D(obj->sliceFrameWidths());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(QCUSTOM3DVOLUME_SLICEFRAMETHICKNESSES)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQVECTOR3D(obj->sliceFrameThicknesses());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
#endif
      RQIMAGE(obj->renderSlice(PQT_AXIS(1), PINT(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
