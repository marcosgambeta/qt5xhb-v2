...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QAbstract3DGraph *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(QABSTRACT3DGRAPH_QUERIEDGRAPHPOSITION)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQVECTOR3D(obj->queriedGraphPosition());
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        ...
        THROW_ERROR_1001("QABSTRACT3DINPUTHANDLER");
      }
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        ...
        THROW_ERROR_1001("QCUSTOM3DITEM");
      }
      hb_itemReturnRelease(pArray);
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
...
#endif
      RQIMAGE(obj->renderToImage(OPINT(1, 0), HB_ISNIL(2) ? QSize() : *PQSIZE(2)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
