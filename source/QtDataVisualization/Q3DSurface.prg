...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<Q3DSurface *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(Q3DSURFACE_NEW)
{
  ...
  if (ISBETWEEN(0, 2) && ISQSURFACEFORMATORNIL(1) && ISQWINDOWORNIL(2)) {
    auto obj = new Q3DSurface(HB_ISNIL(1) ? nullptr : PQSURFACEFORMAT(1), OPQWINDOW(2, nullptr));
