...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<Q3DTheme *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(Q3DTHEME_SETWINDOWCOLOR)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && (ISQCOLOR(1) || HB_ISCHAR(1))) {
#endif
      obj->setWindowColor(HB_ISOBJECT(1) ? *PQCOLOR(1) : QColor(hb_parc(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(Q3DTHEME_SETLABELTEXTCOLOR)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && (ISQCOLOR(1) || HB_ISCHAR(1))) {
#endif
      obj->setLabelTextColor(HB_ISOBJECT(1) ? *PQCOLOR(1) : QColor(hb_parc(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(Q3DTHEME_SETLABELBACKGROUNDCOLOR)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && (ISQCOLOR(1) || HB_ISCHAR(1))) {
#endif
      obj->setLabelBackgroundColor(HB_ISOBJECT(1) ? *PQCOLOR(1) : QColor(hb_parc(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(Q3DTHEME_SETGRIDLINECOLOR)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && (ISQCOLOR(1) || HB_ISCHAR(1))) {
#endif
      obj->setGridLineColor(HB_ISOBJECT(1) ? *PQCOLOR(1) : QColor(hb_parc(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(Q3DTHEME_SETSINGLEHIGHLIGHTCOLOR)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && (ISQCOLOR(1) || HB_ISCHAR(1))) {
#endif
      obj->setSingleHighlightColor(HB_ISOBJECT(1) ? *PQCOLOR(1) : QColor(hb_parc(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(Q3DTHEME_SETMULTIHIGHLIGHTCOLOR)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && (ISQCOLOR(1) || HB_ISCHAR(1))) {
#endif
      obj->setMultiHighlightColor(HB_ISOBJECT(1) ? *PQCOLOR(1) : QColor(hb_parc(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(Q3DTHEME_SETLIGHTCOLOR)
{
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(1) && (ISQCOLOR(1) || HB_ISCHAR(1))) {
#endif
      obj->setLightColor(HB_ISOBJECT(1) ? *PQCOLOR(1) : QColor(hb_parc(1)));
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
      THROW_ERROR_3012();
    }
...
HB_FUNC_STATIC(Q3DTHEME_ONBASECOLORSCHANGED)
{
  ...
  if (sender != nullptr) {
    ...
    if (ISNUMPAR(1) && ISBLOCKORSYMBOL(1)) {
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection = QObject::connect(sender, &Q3DTheme::baseColorsChanged,
                                           [sender, indexOfCodeBlock](const QList<QColor> &arg1) {
                                             auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);
...
HB_FUNC_STATIC(Q3DTHEME_ONBASEGRADIENTSCHANGED)
{
  ...
  if (sender != nullptr) {
    ...
    if (ISNUMPAR(1) && ISBLOCKORSYMBOL(1)) {
      if (Qt5xHb::Signals_connection(sender, indexOfSignal, indexOfCodeBlock)) {
        auto connection = QObject::connect(sender, &Q3DTheme::baseGradientsChanged,
                                           [sender, indexOfCodeBlock](const QList<QLinearGradient> &arg1) {
                                             auto cb = Qt5xHb::Signals_return_codeblock(indexOfCodeBlock);
