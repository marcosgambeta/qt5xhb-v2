    ...
    if( hb_pcount() == 1 )
    {
      if( Signals_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals_return_qobject( (QObject *) sender, "Q3DSCENE" );
            PHB_ITEM pArg1 = Signals_return_qobject( (QObject *) arg1, "Q3DCAMERA" );
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          {
            PHB_ITEM pSender = Signals_return_qobject( (QObject *) sender, "Q3DSCENE" );
            PHB_ITEM pArg1 = Signals_return_qobject( (QObject *) arg1, "Q3DLIGHT" );
            hb_vmEvalBlockV( cb, 2, pSender, pArg1 );
            hb_itemRelease( pSender );
            hb_itemRelease( pArg1 );
          }
