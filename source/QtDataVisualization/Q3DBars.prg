...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<Q3DBars *>(Qt5xHb::getQObjectPointerFromSelfItem())
  ...
  if (obj != nullptr) {
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != nullptr) {
        ...
        THROW_ERROR_1001("QABSTRACT3DAXIS");
      }
      hb_itemReturnRelease(pArray);
#ifndef QT5XHB_DONT_CHECK_PARAMETERS
    } else {
