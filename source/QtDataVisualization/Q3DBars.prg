...
HB_FUNC_STATIC( Q3DBARS_NEW )
{
  ...
  {
    auto obj = new Q3DBars ( ISNIL(1)? nullptr : (QSurfaceFormat *) _qt5xhb_itemGetPtr(1), OPQWINDOW(2,nullptr) );
...
{
#if (QT_VERSION >= QT_VERSION_CHECK(5,7,0))
  Q3DBars * sender = (Q3DBars *) _qt5xhb_itemGetPtrStackSelfItem();
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals4_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          if( cb != nullptr )
          {
            PHB_ITEM pSender = Signals4_return_qobject ( (QObject *) sender, "Q3DBARS" );
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals4_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          {
            PHB_ITEM pSender = Signals4_return_qobject ( (QObject *) sender, "Q3DBARS" );
            PHB_ITEM pArg1 = Signals4_return_qobject( (QObject *) arg1, "QCATEGORY3DAXIS" );
            hb_vmEvalBlockV( cb, 2, pSender, pArg1 );
            hb_itemRelease( pSender );
            hb_itemRelease( pArg1 );
          }
    ...
    if( hb_pcount() == 1 )
    {
      if( Signals4_connection( sender, indexOfSignal, indexOfCodeBlock ) )
      {
        ...
        QMetaObject::Connection connection = QObject::connect(sender, 
          ...
          {
            PHB_ITEM pSender = Signals4_return_qobject ( (QObject *) sender, "Q3DBARS" );
            PHB_ITEM pArg1 = Signals4_return_qobject( (QObject *) arg1, "QBAR3DSERIES" );
            hb_vmEvalBlockV( cb, 2, pSender, pArg1 );
            hb_itemRelease( pSender );
            hb_itemRelease( pArg1 );
          }
