...
#define GET_PTR_FROM_SELF(p) auto p = qobject_cast<QCustom3DItem *>(Qt5xHb::getQObjectPointerFromSelfItem())
...
#endif
  } else if (ISBETWEEN(5, 6) && ISQSTRING(1) && ISQVECTOR3D(2) && ISQVECTOR3D(3) && ISQQUATERNION(4) && ISQIMAGE(5) &&
             ISQOBJECTORNIL(6)) {
