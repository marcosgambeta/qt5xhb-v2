...
#define OPQWEBENGINECOOKIESTORE(n,v)                        HB_ISNIL(n)? v : (QWebEngineCookieStore *) Qt5xHb::itemGetPtr(n)
#define OPQWEBENGINEHTTPREQUEST(n,v)                        HB_ISNIL(n)? v : (QWebEngineHttpRequest *) Qt5xHb::itemGetPtr(n)
#define OPQWEBENGINEURLREQUESTINFO(n,v)                     HB_ISNIL(n)? v : (QWebEngineUrlRequestInfo *) Qt5xHb::itemGetPtr(n)
#define OPQWEBENGINEURLREQUESTINTERCEPTOR(n,v)              HB_ISNIL(n)? v : (QWebEngineUrlRequestInterceptor *) Qt5xHb::itemGetPtr(n)
#define OPQWEBENGINEURLREQUESTJOB(n,v)                      HB_ISNIL(n)? v : (QWebEngineUrlRequestJob *) Qt5xHb::itemGetPtr(n)
#define OPQWEBENGINEURLSCHEMEHANDLER(n,v)                   HB_ISNIL(n)? v : (QWebEngineUrlSchemeHandler *) Qt5xHb::itemGetPtr(n)
