...
#define PQGEOCODEREPLY_ERROR(n)                             static_cast<QGeoCodeReply::Error>(hb_parni(n))
#define PQGEOMANEUVER_INSTRUCTIONDIRECTION(n)               static_cast<QGeoManeuver::InstructionDirection>(hb_parni(n))
#define PQGEOROUTEREPLY_ERROR(n)                            static_cast<QGeoRouteReply::Error>(hb_parni(n))
#define PQGEOROUTEREQUEST_FEATURETYPE(n)                    static_cast<QGeoRouteRequest::FeatureType>(hb_parni(n))
#define PQGEOROUTEREQUEST_FEATURETYPES(n)                   static_cast<QGeoRouteRequest::FeatureTypes>(hb_parni(n))
#define PQGEOROUTEREQUEST_FEATUREWEIGHT(n)                  static_cast<QGeoRouteRequest::FeatureWeight>(hb_parni(n))
#define PQGEOROUTEREQUEST_FEATUREWEIGHTS(n)                 static_cast<QGeoRouteRequest::FeatureWeights>(hb_parni(n))
#define PQGEOROUTEREQUEST_MANEUVERDETAIL(n)                 static_cast<QGeoRouteRequest::ManeuverDetail>(hb_parni(n))
#define PQGEOROUTEREQUEST_MANEUVERDETAILS(n)                static_cast<QGeoRouteRequest::ManeuverDetails>(hb_parni(n))
#define PQGEOROUTEREQUEST_ROUTEOPTIMIZATIONS(n)             static_cast<QGeoRouteRequest::RouteOptimizations>(hb_parni(n))
#define PQGEOROUTEREQUEST_SEGMENTDETAIL(n)                  static_cast<QGeoRouteRequest::SegmentDetail>(hb_parni(n))
#define PQGEOROUTEREQUEST_SEGMENTDETAILS(n)                 static_cast<QGeoRouteRequest::SegmentDetails>(hb_parni(n))
#define PQGEOROUTEREQUEST_TRAVELMODE(n)                     static_cast<QGeoRouteRequest::TravelMode>(hb_parni(n))
#define PQGEOROUTEREQUEST_TRAVELMODES(n)                    static_cast<QGeoRouteRequest::TravelModes>(hb_parni(n))
#define PQGEOSERVICEPROVIDER_ERROR(n)                       static_cast<QGeoServiceProvider::Error>(hb_parni(n))
#define PQGEOSERVICEPROVIDER_GEOCODINGFEATURES(n)           static_cast<QGeoServiceProvider::GeocodingFeatures>(hb_parni(n))
#define PQGEOSERVICEPROVIDER_MAPPINGFEATURES(n)             static_cast<QGeoServiceProvider::MappingFeatures>(hb_parni(n))
#define PQGEOSERVICEPROVIDER_PLACESFEATURES(n)              static_cast<QGeoServiceProvider::PlacesFeatures>(hb_parni(n))
#define PQGEOSERVICEPROVIDER_ROUTINGFEATURES(n)             static_cast<QGeoServiceProvider::RoutingFeatures>(hb_parni(n))
#define PQLOCATION_VISIBILITY(n)                            static_cast<QLocation::Visibility>(hb_parni(n))
#define PQLOCATION_VISIBILITYSCOPE(n)                       static_cast<QLocation::VisibilityScope>(hb_parni(n))
#define PQPLACECONTENT_TYPE(n)                              static_cast<QPlaceContent::Type>(hb_parni(n))
#define PQPLACEIDREPLY_OPERATIONTYPE(n)                     static_cast<QPlaceIdReply::OperationType>(hb_parni(n))
#define PQPLACEREPLY_ERROR(n)                               static_cast<QPlaceReply::Error>(hb_parni(n))
#define PQPLACEREPLY_TYPE(n)                                static_cast<QPlaceReply::Type>(hb_parni(n))
#define PQPLACESEARCHREQUEST_RELEVANCEHINT(n)               static_cast<QPlaceSearchRequest::RelevanceHint>(hb_parni(n))
#define PQPLACESEARCHRESULT_SEARCHRESULTTYPE(n)             static_cast<QPlaceSearchResult::SearchResultType>(hb_parni(n))

#define RQGEOMANEUVER(exp)                                  Qt5xHb::createReturnClass(new QGeoManeuver(exp), "QGEOMANEUVER", true)
#define RQGEOROUTE(exp)                                     Qt5xHb::createReturnClass(new QGeoRoute(exp), "QGEOROUTE", true)
#define RQGEOROUTEREQUEST(exp)                              Qt5xHb::createReturnClass(new QGeoRouteRequest(exp), "QGEOROUTEREQUEST", true)
#define RQGEOROUTESEGMENT(exp)                              Qt5xHb::createReturnClass(new QGeoRouteSegment(exp), "QGEOROUTESEGMENT", true)
#define RQGEOSERVICEPROVIDERFACTORY(exp)                    Qt5xHb::createReturnClass(new QGeoServiceProviderFactory(exp), "QGEOSERVICEPROVIDERFACTORY", true)
#define RQPLACE(exp)                                        Qt5xHb::createReturnClass(new QPlace(exp), "QPLACE", true)
#define RQPLACEATTRIBUTE(exp)                               Qt5xHb::createReturnClass(new QPlaceAttribute(exp), "QPLACEATTRIBUTE", true)
#define RQPLACECATEGORY(exp)                                Qt5xHb::createReturnClass(new QPlaceCategory(exp), "QPLACECATEGORY", true)
#define RQPLACECONTACTDETAIL(exp)                           Qt5xHb::createReturnClass(new QPlaceContactDetail(exp), "QPLACECONTACTDETAIL", true)
#define RQPLACECONTENT(exp)                                 Qt5xHb::createReturnClass(new QPlaceContent(exp), "QPLACECONTENT", true)
#define RQPLACECONTENTREQUEST(exp)                          Qt5xHb::createReturnClass(new QPlaceContentRequest(exp), "QPLACECONTENTREQUEST", true)
#define RQPLACEEDITORIAL(exp)                               Qt5xHb::createReturnClass(new QPlaceEditorial(exp), "QPLACEEDITORIAL", true)
#define RQPLACEICON(exp)                                    Qt5xHb::createReturnClass(new QPlaceIcon(exp), "QPLACEICON", true)
#define RQPLACEIMAGE(exp)                                   Qt5xHb::createReturnClass(new QPlaceImage(exp), "QPLACEIMAGE", true)
#define RQPLACEMATCHREQUEST(exp)                            Qt5xHb::createReturnClass(new QPlaceMatchRequest(exp), "QPLACEMATCHREQUEST", true)
#define RQPLACEPROPOSEDSEARCHRESULT(exp)                    Qt5xHb::createReturnClass(new QPlaceProposedSearchResult(exp), "QPLACEPROPOSEDSEARCHRESULT", true)
#define RQPLACERATINGS(exp)                                 Qt5xHb::createReturnClass(new QPlaceRatings(exp), "QPLACERATINGS", true)
#define RQPLACERESULT(exp)                                  Qt5xHb::createReturnClass(new QPlaceResult(exp), "QPLACERESULT", true)
#define RQPLACEREVIEW(exp)                                  Qt5xHb::createReturnClass(new QPlaceReview(exp), "QPLACEREVIEW", true)
#define RQPLACESEARCHREQUEST(exp)                           Qt5xHb::createReturnClass(new QPlaceSearchRequest(exp), "QPLACESEARCHREQUEST", true)
#define RQPLACESEARCHRESULT(exp)                            Qt5xHb::createReturnClass(new QPlaceSearchResult(exp), "QPLACESEARCHRESULT", true)
#define RQPLACESUPPLIER(exp)                                Qt5xHb::createReturnClass(new QPlaceSupplier(exp), "QPLACESUPPLIER", true)
#define RQPLACEUSER(exp)                                    Qt5xHb::createReturnClass(new QPlaceUser(exp), "QPLACEUSER", true)
