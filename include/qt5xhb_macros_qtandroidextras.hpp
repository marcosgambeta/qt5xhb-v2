...
#define PQANDROIDBINDER_CALLTYPE(n)                         static_cast<QAndroidBinder::CallType>(hb_parni(n))
#define PQANDROIDJNIEXCEPTIONCLEANER_OUTPUTMODE(n)          static_cast<QAndroidJniExceptionCleaner::OutputMode>(hb_parni(n))

#define RQANDROIDACTIVITYRESULTRECEIVER(exp)                Qt5xHb::createReturnClass(new QAndroidActivityResultReceiver(exp), "QANDROIDACTIVITYRESULTRECEIVER", true)
#define RQANDROIDBINDER(exp)                                Qt5xHb::createReturnClass(new QAndroidBinder(exp), "QANDROIDBINDER", true)
#define RQANDROIDINTENT(exp)                                Qt5xHb::createReturnClass(new QAndroidIntent(exp), "QANDROIDINTENT", true)
#define RQANDROIDJNIENVIRONMENT(exp)                        Qt5xHb::createReturnClass(new QAndroidJniEnvironment(exp), "QANDROIDJNIENVIRONMENT", true)
#define RQANDROIDJNIEXCEPTIONCLEANER(exp)                   Qt5xHb::createReturnClass(new QAndroidJniExceptionCleaner(exp), "QANDROIDJNIEXCEPTIONCLEANER", true)
#define RQANDROIDJNIOBJECT(exp)                             Qt5xHb::createReturnClass(new QAndroidJniObject(exp), "QANDROIDJNIOBJECT", true)
#define RQANDROIDPARCEL(exp)                                Qt5xHb::createReturnClass(new QAndroidParcel(exp), "QANDROIDPARCEL", true)
#define RQANDROIDSERVICECONNECTION(exp)                     Qt5xHb::createReturnClass(new QAndroidServiceConnection(exp), "QANDROIDSERVICECONNECTION", true)
#define RQTANDROID(exp)                                     Qt5xHb::createReturnClass(new QtAndroid(exp), "QTANDROID", true)
