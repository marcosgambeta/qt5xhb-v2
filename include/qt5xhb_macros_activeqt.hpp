...
#define ISQAXSELECTORNIL(n)                                 (ISQAXSELECT(n) || HB_ISNIL(n))
...
#define PQAXSELECT_SANDBOXINGLEVEL(n)                       static_cast<QAxSelect::SandboxingLevel>(hb_parni(n))

#define RQAXBASE(exp)                                       Qt5xHb::createReturnClass(new QAxBase(exp), "QAXBASE", true)
