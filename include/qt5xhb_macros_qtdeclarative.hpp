...
#ifndef QT5XHB_MACROS_QTDECLARATIVE_HPP
#define QT5XHB_MACROS_QTDECLARATIVE_HPP
...
#define ISQDECLARATIVECOMPONENTORNIL(n)                     (ISQDECLARATIVECOMPONENT(n) || HB_ISNIL(n))
#define ISQDECLARATIVECONTEXTORNIL(n)                       (ISQDECLARATIVECONTEXT(n) || HB_ISNIL(n))
#define ISQDECLARATIVEENGINEORNIL(n)                        (ISQDECLARATIVEENGINE(n) || HB_ISNIL(n))
#define ISQDECLARATIVEERRORORNIL(n)                         (ISQDECLARATIVEERROR(n) || HB_ISNIL(n))
#define ISQDECLARATIVEEXPRESSIONORNIL(n)                    (ISQDECLARATIVEEXPRESSION(n) || HB_ISNIL(n))
#define ISQDECLARATIVEEXTENSIONPLUGINORNIL(n)               (ISQDECLARATIVEEXTENSIONPLUGIN(n) || HB_ISNIL(n))
#define ISQDECLARATIVEIMAGEPROVIDERORNIL(n)                 (ISQDECLARATIVEIMAGEPROVIDER(n) || HB_ISNIL(n))
#define ISQDECLARATIVEITEMORNIL(n)                          (ISQDECLARATIVEITEM(n) || HB_ISNIL(n))
#define ISQDECLARATIVELISTREFERENCEORNIL(n)                 (ISQDECLARATIVELISTREFERENCE(n) || HB_ISNIL(n))
#define ISQDECLARATIVENETWORKACCESSMANAGERFACTORYORNIL(n)   (ISQDECLARATIVENETWORKACCESSMANAGERFACTORY(n) || HB_ISNIL(n))
#define ISQDECLARATIVEPARSERSTATUSORNIL(n)                  (ISQDECLARATIVEPARSERSTATUS(n) || HB_ISNIL(n))
#define ISQDECLARATIVEPROPERTYORNIL(n)                      (ISQDECLARATIVEPROPERTY(n) || HB_ISNIL(n))
#define ISQDECLARATIVEPROPERTYMAPORNIL(n)                   (ISQDECLARATIVEPROPERTYMAP(n) || HB_ISNIL(n))
#define ISQDECLARATIVEPROPERTYVALUESOURCEORNIL(n)           (ISQDECLARATIVEPROPERTYVALUESOURCE(n) || HB_ISNIL(n))
#define ISQDECLARATIVESCRIPTSTRINGORNIL(n)                  (ISQDECLARATIVESCRIPTSTRING(n) || HB_ISNIL(n))
#define ISQDECLARATIVEVIEWORNIL(n)                          (ISQDECLARATIVEVIEW(n) || HB_ISNIL(n))
...
#define RQDECLARATIVEERROR(exp)                             Qt5xHb::createReturnClass(new QDeclarativeError(exp), "QDECLARATIVEERROR", true)
#define RQDECLARATIVEIMAGEPROVIDER(exp)                     Qt5xHb::createReturnClass(new QDeclarativeImageProvider(exp), "QDECLARATIVEIMAGEPROVIDER", true)
#define RQDECLARATIVELISTREFERENCE(exp)                     Qt5xHb::createReturnClass(new QDeclarativeListReference(exp), "QDECLARATIVELISTREFERENCE", true)
#define RQDECLARATIVENETWORKACCESSMANAGERFACTORY(exp)       Qt5xHb::createReturnClass(new QDeclarativeNetworkAccessManagerFactory(exp), "QDECLARATIVENETWORKACCESSMANAGERFACTORY", true)
#define RQDECLARATIVEPARSERSTATUS(exp)                      Qt5xHb::createReturnClass(new QDeclarativeParserStatus(exp), "QDECLARATIVEPARSERSTATUS", true)
#define RQDECLARATIVEPROPERTY(exp)                          Qt5xHb::createReturnClass(new QDeclarativeProperty(exp), "QDECLARATIVEPROPERTY", true)
#define RQDECLARATIVEPROPERTYVALUESOURCE(exp)               Qt5xHb::createReturnClass(new QDeclarativePropertyValueSource(exp), "QDECLARATIVEPROPERTYVALUESOURCE", true)
#define RQDECLARATIVESCRIPTSTRING(exp)                      Qt5xHb::createReturnClass(new QDeclarativeScriptString(exp), "QDECLARATIVESCRIPTSTRING", true)

#endif // QT5XHB_MACROS_QTDECLARATIVE_HPP
