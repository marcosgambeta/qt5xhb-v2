...
#define PCHAR(n)                                            HB_ISCHAR(n)? (char) hb_parc(n)[0] : (HB_ISNUM(n)? hb_parni(n) : 0)
...
#define OPBOOL(n,v)                                         (bool) HB_ISNIL(n)? v : hb_parl(n)
#define OPCHAR(n,v)                                         (char) HB_ISNIL(n)? v : hb_parni(n)
#define OPUSHORT(n,v)                                       (ushort) HB_ISNIL(n)? v : hb_parni(n)
#define OPINT(n,v)                                          (int) HB_ISNIL(n)? v : hb_parni(n)
#define OPUINT(n,v)                                         (uint) HB_ISNIL(n)? v : hb_parni(n)
#define OPFLOAT(n,v)                                        (float) HB_ISNIL(n)? v : hb_parnd(n)
#define OPDOUBLE(n,v)                                       (double) HB_ISNIL(n)? v : hb_parnd(n)
#define OPQREAL(n,v)                                        (qreal) HB_ISNIL(n)? v : hb_parnd(n)
...
#define OPQINT8(n,v)                                        (qint8) HB_ISNIL(n)? v : hb_parni(n)
#define OPQINT16(n,v)                                       (qint16) HB_ISNIL(n)? v : hb_parni(n)
#define OPQINT32(n,v)                                       (qint32) HB_ISNIL(n)? v : hb_parni(n)
#define OPQINT64(n,v)                                       (qint64) HB_ISNIL(n)? v : hb_parnll(n)
#define OPQUINT8(n,v)                                       (quint8) HB_ISNIL(n)? v : hb_parni(n)
#define OPQUINT16(n,v)                                      (quint16) HB_ISNIL(n)? v : hb_parni(n)
#define OPQUINT32(n,v)                                      (quint32) HB_ISNIL(n)? v : hb_parni(n)
#define OPQUINT64(n,v)                                      (quint64) HB_ISNIL(n)? v : hb_parnll(n)
#define OPGLINT(n,v)                                        (GLint) HB_ISNIL(n)? v : hb_parni(n)
#define OPGLUINT(n,v)                                       (GLuint) HB_ISNIL(n)? v : hb_parni(n)
#define OPGLUINT64(n,v)                                     (GLuint64) HB_ISNIL(n)? v : hb_parnll(n)
#define OPGLFLOAT(n,v)                                      (GLfloat) HB_ISNIL(n)? v : hb_parnd(n)
#define OPGLENUM(n,v)                                       (GLenum) HB_ISNIL(n)? v : hb_parni(n)
#define OPGLBITFIELD(n,v)                                   (GLbitfield) HB_ISNIL(n)? v : hb_parni(n)
#define OPGLSIZEI(n,v)                                      (GLsizei) HB_ISNIL(n)? v : hb_parni(n)
