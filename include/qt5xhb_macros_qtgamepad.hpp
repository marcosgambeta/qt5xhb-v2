...
#define PQGAMEPADMANAGER_GAMEPADAXIS(n)                     static_cast<QGamepadManager::GamepadAxis>(hb_parni(n))
#define PQGAMEPADMANAGER_GAMEPADBUTTON(n)                   static_cast<QGamepadManager::GamepadButton>(hb_parni(n))
