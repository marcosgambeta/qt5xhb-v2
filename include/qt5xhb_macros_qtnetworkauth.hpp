...
#ifndef QT5XHB_MACROS_QTNETWORKAUTH_HPP
#define QT5XHB_MACROS_QTNETWORKAUTH_HPP
...
#define ISQABSTRACTOAUTHORNIL(n)                            (ISQABSTRACTOAUTH(n) || HB_ISNIL(n))
#define ISQABSTRACTOAUTH2ORNIL(n)                           (ISQABSTRACTOAUTH2(n) || HB_ISNIL(n))
#define ISQABSTRACTOAUTHREPLYHANDLERORNIL(n)                (ISQABSTRACTOAUTHREPLYHANDLER(n) || HB_ISNIL(n))
#define ISQOAUTH1ORNIL(n)                                   (ISQOAUTH1(n) || HB_ISNIL(n))
#define ISQOAUTH1SIGNATUREORNIL(n)                          (ISQOAUTH1SIGNATURE(n) || HB_ISNIL(n))
#define ISQOAUTH2AUTHORIZATIONCODEFLOWORNIL(n)              (ISQOAUTH2AUTHORIZATIONCODEFLOW(n) || HB_ISNIL(n))
#define ISQOAUTHHTTPSERVERREPLYHANDLERORNIL(n)              (ISQOAUTHHTTPSERVERREPLYHANDLER(n) || HB_ISNIL(n))
#define ISQOAUTHOOBREPLYHANDLERORNIL(n)                     (ISQOAUTHOOBREPLYHANDLER(n) || HB_ISNIL(n))
...
#define PQABSTRACTOAUTH_CONTENTTYPE(n)                      static_cast<QAbstractOAuth::ContentType>(hb_parni(n))
#define PQABSTRACTOAUTH_ERROR(n)                            static_cast<QAbstractOAuth::Error>(hb_parni(n))
#define PQABSTRACTOAUTH_STATUS(n)                           static_cast<QAbstractOAuth::Status>(hb_parni(n))
#define PQOAUTH1_SIGNATUREMETHOD(n)                         static_cast<QOAuth1::SignatureMethod>(hb_parni(n))
#define PQOAUTH1SIGNATURE_HTTPREQUESTMETHOD(n)              static_cast<QOAuth1Signature::HttpRequestMethod>(hb_parni(n))

#define RQOAUTH1SIGNATURE(exp)                              Qt5xHb::createReturnClass(new QOAuth1Signature(exp), "QOAUTH1SIGNATURE", true)

#endif // QT5XHB_MACROS_QTNETWORKAUTH_HPP
