...
#ifndef QT5XHB_MACROS_QTQML_HPP
#define QT5XHB_MACROS_QTQML_HPP
...
#define ISQJSENGINEORNIL(n)                                 (ISQJSENGINE(n) || HB_ISNIL(n))
#define ISQJSVALUEORNIL(n)                                  (ISQJSVALUE(n) || HB_ISNIL(n))
#define ISQJSVALUEITERATORORNIL(n)                          (ISQJSVALUEITERATOR(n) || HB_ISNIL(n))
#define ISQQMLAPPLICATIONENGINEORNIL(n)                     (ISQQMLAPPLICATIONENGINE(n) || HB_ISNIL(n))
#define ISQQMLCOMPONENTORNIL(n)                             (ISQQMLCOMPONENT(n) || HB_ISNIL(n))
#define ISQQMLCONTEXTORNIL(n)                               (ISQQMLCONTEXT(n) || HB_ISNIL(n))
#define ISQQMLENGINEORNIL(n)                                (ISQQMLENGINE(n) || HB_ISNIL(n))
#define ISQQMLERRORORNIL(n)                                 (ISQQMLERROR(n) || HB_ISNIL(n))
#define ISQQMLEXPRESSIONORNIL(n)                            (ISQQMLEXPRESSION(n) || HB_ISNIL(n))
#define ISQQMLEXTENSIONPLUGINORNIL(n)                       (ISQQMLEXTENSIONPLUGIN(n) || HB_ISNIL(n))
#define ISQQMLIMAGEPROVIDERBASEORNIL(n)                     (ISQQMLIMAGEPROVIDERBASE(n) || HB_ISNIL(n))
#define ISQQMLINCUBATIONCONTROLLERORNIL(n)                  (ISQQMLINCUBATIONCONTROLLER(n) || HB_ISNIL(n))
#define ISQQMLINCUBATORORNIL(n)                             (ISQQMLINCUBATOR(n) || HB_ISNIL(n))
#define ISQQMLLISTPROPERTYORNIL(n)                          (ISQQMLLISTPROPERTY(n) || HB_ISNIL(n))
#define ISQQMLLISTREFERENCEORNIL(n)                         (ISQQMLLISTREFERENCE(n) || HB_ISNIL(n))
#define ISQQMLNETWORKACCESSMANAGERFACTORYORNIL(n)           (ISQQMLNETWORKACCESSMANAGERFACTORY(n) || HB_ISNIL(n))
#define ISQQMLPARSERSTATUSORNIL(n)                          (ISQQMLPARSERSTATUS(n) || HB_ISNIL(n))
#define ISQQMLPROPERTYORNIL(n)                              (ISQQMLPROPERTY(n) || HB_ISNIL(n))
#define ISQQMLPROPERTYMAPORNIL(n)                           (ISQQMLPROPERTYMAP(n) || HB_ISNIL(n))
#define ISQQMLPROPERTYVALUESOURCEORNIL(n)                   (ISQQMLPROPERTYVALUESOURCE(n) || HB_ISNIL(n))
#define ISQQMLSCRIPTSTRINGORNIL(n)                          (ISQQMLSCRIPTSTRING(n) || HB_ISNIL(n))
...
#define PQJSVALUE_SPECIALVALUE(n)                           static_cast<QJSValue::SpecialValue>(hb_parni(n))
#define PQQMLCOMPONENT_COMPILATIONMODE(n)                   static_cast<QQmlComponent::CompilationMode>(hb_parni(n))
#define PQQMLCOMPONENT_STATUS(n)                            static_cast<QQmlComponent::Status>(hb_parni(n))
#define PQQMLENGINE_OBJECTOWNERSHIP(n)                      static_cast<QQmlEngine::ObjectOwnership>(hb_parni(n))
#define PQQMLIMAGEPROVIDERBASE_FLAGS(n)                     static_cast<QQmlImageProviderBase::Flags>(hb_parni(n))
#define PQQMLIMAGEPROVIDERBASE_IMAGETYPE(n)                 static_cast<QQmlImageProviderBase::ImageType>(hb_parni(n))
#define PQQMLINCUBATOR_INCUBATIONMODE(n)                    static_cast<QQmlIncubator::IncubationMode>(hb_parni(n))
#define PQQMLINCUBATOR_STATUS(n)                            static_cast<QQmlIncubator::Status>(hb_parni(n))
#define PQQMLPROPERTY_PROPERTYTYPECATEGORY(n)               static_cast<QQmlProperty::PropertyTypeCategory>(hb_parni(n))
#define PQQMLPROPERTY_TYPE(n)                               static_cast<QQmlProperty::Type>(hb_parni(n))

#define RQJSVALUE(exp)                                      Qt5xHb::createReturnClass(new QJSValue(exp), "QJSVALUE", true)
#define RQJSVALUEITERATOR(exp)                              Qt5xHb::createReturnClass(new QJSValueIterator(exp), "QJSVALUEITERATOR", true)
#define RQQMLERROR(exp)                                     Qt5xHb::createReturnClass(new QQmlError(exp), "QQMLERROR", true)
#define RQQMLIMAGEPROVIDERBASE(exp)                         Qt5xHb::createReturnClass(new QQmlImageProviderBase(exp), "QQMLIMAGEPROVIDERBASE", true)
#define RQQMLINCUBATIONCONTROLLER(exp)                      Qt5xHb::createReturnClass(new QQmlIncubationController(exp), "QQMLINCUBATIONCONTROLLER", true)
#define RQQMLINCUBATOR(exp)                                 Qt5xHb::createReturnClass(new QQmlIncubator(exp), "QQMLINCUBATOR", true)
#define RQQMLLISTPROPERTY(exp)                              Qt5xHb::createReturnClass(new QQmlListProperty(exp), "QQMLLISTPROPERTY", true)
#define RQQMLLISTREFERENCE(exp)                             Qt5xHb::createReturnClass(new QQmlListReference(exp), "QQMLLISTREFERENCE", true)
#define RQQMLNETWORKACCESSMANAGERFACTORY(exp)               Qt5xHb::createReturnClass(new QQmlNetworkAccessManagerFactory(exp), "QQMLNETWORKACCESSMANAGERFACTORY", true)
#define RQQMLPARSERSTATUS(exp)                              Qt5xHb::createReturnClass(new QQmlParserStatus(exp), "QQMLPARSERSTATUS", true)
#define RQQMLPROPERTY(exp)                                  Qt5xHb::createReturnClass(new QQmlProperty(exp), "QQMLPROPERTY", true)
#define RQQMLPROPERTYVALUESOURCE(exp)                       Qt5xHb::createReturnClass(new QQmlPropertyValueSource(exp), "QQMLPROPERTYVALUESOURCE", true)
#define RQQMLSCRIPTSTRING(exp)                              Qt5xHb::createReturnClass(new QQmlScriptString(exp), "QQMLSCRIPTSTRING", true)

#endif // QT5XHB_MACROS_QTQML_HPP
