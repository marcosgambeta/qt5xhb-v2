...
#define OPQSCXMLCOMPILER(n,v)                               HB_ISNIL(n)? v : (QScxmlCompiler *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLCPPDATAMODEL(n,v)                           HB_ISNIL(n)? v : (QScxmlCppDataModel *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLDATAMODEL(n,v)                              HB_ISNIL(n)? v : (QScxmlDataModel *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLDYNAMICSCXMLSERVICEFACTORY(n,v)             HB_ISNIL(n)? v : (QScxmlDynamicScxmlServiceFactory *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLECMASCRIPTDATAMODEL(n,v)                    HB_ISNIL(n)? v : (QScxmlEcmaScriptDataModel *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLERROR(n,v)                                  HB_ISNIL(n)? v : (QScxmlError *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLEVENT(n,v)                                  HB_ISNIL(n)? v : (QScxmlEvent *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLINVOKABLESERVICE(n,v)                       HB_ISNIL(n)? v : (QScxmlInvokableService *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLINVOKABLESERVICEFACTORY(n,v)                HB_ISNIL(n)? v : (QScxmlInvokableServiceFactory *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLNULLDATAMODEL(n,v)                          HB_ISNIL(n)? v : (QScxmlNullDataModel *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLSTATEMACHINE(n,v)                           HB_ISNIL(n)? v : (QScxmlStateMachine *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLSTATICSCXMLSERVICEFACTORY(n,v)              HB_ISNIL(n)? v : (QScxmlStaticScxmlServiceFactory *) Qt5xHb::itemGetPtr(n)
#define OPQSCXMLTABLEDATA(n,v)                              HB_ISNIL(n)? v : (QScxmlTableData *) Qt5xHb::itemGetPtr(n)
