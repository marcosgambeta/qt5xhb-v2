...
#ifndef QT5XHB_MACROS_QTSVG_HPP
#define QT5XHB_MACROS_QTSVG_HPP
...
#define RQSVGGENERATOR(exp)                                 Qt5xHb::createReturnClass(new QSvgGenerator(exp), "QSVGGENERATOR", true)

#endif // QT5XHB_MACROS_QTSVG_HPP
