...
#define RQABSTRACTEXTENSIONFACTORY(exp)                     Qt5xHb::createReturnClass(new QAbstractExtensionFactory(exp), "QABSTRACTEXTENSIONFACTORY", true)
#define RQABSTRACTEXTENSIONMANAGER(exp)                     Qt5xHb::createReturnClass(new QAbstractExtensionManager(exp), "QABSTRACTEXTENSIONMANAGER", true)
#define RQABSTRACTFORMBUILDER(exp)                          Qt5xHb::createReturnClass(new QAbstractFormBuilder(exp), "QABSTRACTFORMBUILDER", true)
#define RQDESIGNERCONTAINEREXTENSION(exp)                   Qt5xHb::createReturnClass(new QDesignerContainerExtension(exp), "QDESIGNERCONTAINEREXTENSION", true)
#define RQDESIGNERCUSTOMWIDGETCOLLECTIONINTERFACE(exp)      Qt5xHb::createReturnClass(new QDesignerCustomWidgetCollectionInterface(exp), "QDESIGNERCUSTOMWIDGETCOLLECTIONINTERFACE", true)
#define RQDESIGNERDYNAMICPROPERTYSHEETEXTENSION(exp)        Qt5xHb::createReturnClass(new QDesignerDynamicPropertySheetExtension(exp), "QDESIGNERDYNAMICPROPERTYSHEETEXTENSION", true)
#define RQDESIGNERFORMWINDOWCURSORINTERFACE(exp)            Qt5xHb::createReturnClass(new QDesignerFormWindowCursorInterface(exp), "QDESIGNERFORMWINDOWCURSORINTERFACE", true)
#define RQDESIGNERMEMBERSHEETEXTENSION(exp)                 Qt5xHb::createReturnClass(new QDesignerMemberSheetExtension(exp), "QDESIGNERMEMBERSHEETEXTENSION", true)
#define RQDESIGNERPROPERTYSHEETEXTENSION(exp)               Qt5xHb::createReturnClass(new QDesignerPropertySheetExtension(exp), "QDESIGNERPROPERTYSHEETEXTENSION", true)
#define RQDESIGNERTASKMENUEXTENSION(exp)                    Qt5xHb::createReturnClass(new QDesignerTaskMenuExtension(exp), "QDESIGNERTASKMENUEXTENSION", true)
#define RQFORMBUILDER(exp)                                  Qt5xHb::createReturnClass(new QFormBuilder(exp), "QFORMBUILDER", true)
