...
#ifndef QT5XHB_MACROS_QTDATAVISUALIZATION_HPP
#define QT5XHB_MACROS_QTDATAVISUALIZATION_HPP
...
#define ISQ3DBARSORNIL(n)                                   (ISQ3DBARS(n) || HB_ISNIL(n))
#define ISQ3DCAMERAORNIL(n)                                 (ISQ3DCAMERA(n) || HB_ISNIL(n))
#define ISQ3DINPUTHANDLERORNIL(n)                           (ISQ3DINPUTHANDLER(n) || HB_ISNIL(n))
#define ISQ3DLIGHTORNIL(n)                                  (ISQ3DLIGHT(n) || HB_ISNIL(n))
#define ISQ3DOBJECTORNIL(n)                                 (ISQ3DOBJECT(n) || HB_ISNIL(n))
#define ISQ3DSCATTERORNIL(n)                                (ISQ3DSCATTER(n) || HB_ISNIL(n))
#define ISQ3DSCENEORNIL(n)                                  (ISQ3DSCENE(n) || HB_ISNIL(n))
#define ISQ3DSURFACEORNIL(n)                                (ISQ3DSURFACE(n) || HB_ISNIL(n))
#define ISQ3DTHEMEORNIL(n)                                  (ISQ3DTHEME(n) || HB_ISNIL(n))
#define ISQABSTRACT3DAXISORNIL(n)                           (ISQABSTRACT3DAXIS(n) || HB_ISNIL(n))
#define ISQABSTRACT3DGRAPHORNIL(n)                          (ISQABSTRACT3DGRAPH(n) || HB_ISNIL(n))
#define ISQABSTRACT3DINPUTHANDLERORNIL(n)                   (ISQABSTRACT3DINPUTHANDLER(n) || HB_ISNIL(n))
#define ISQABSTRACT3DSERIESORNIL(n)                         (ISQABSTRACT3DSERIES(n) || HB_ISNIL(n))
#define ISQABSTRACTDATAPROXYORNIL(n)                        (ISQABSTRACTDATAPROXY(n) || HB_ISNIL(n))
#define ISQBAR3DSERIESORNIL(n)                              (ISQBAR3DSERIES(n) || HB_ISNIL(n))
#define ISQBARDATAITEMORNIL(n)                              (ISQBARDATAITEM(n) || HB_ISNIL(n))
#define ISQBARDATAPROXYORNIL(n)                             (ISQBARDATAPROXY(n) || HB_ISNIL(n))
#define ISQCATEGORY3DAXISORNIL(n)                           (ISQCATEGORY3DAXIS(n) || HB_ISNIL(n))
#define ISQCUSTOM3DITEMORNIL(n)                             (ISQCUSTOM3DITEM(n) || HB_ISNIL(n))
#define ISQCUSTOM3DLABELORNIL(n)                            (ISQCUSTOM3DLABEL(n) || HB_ISNIL(n))
#define ISQCUSTOM3DVOLUMEORNIL(n)                           (ISQCUSTOM3DVOLUME(n) || HB_ISNIL(n))
#define ISQHEIGHTMAPSURFACEDATAPROXYORNIL(n)                (ISQHEIGHTMAPSURFACEDATAPROXY(n) || HB_ISNIL(n))
#define ISQITEMMODELBARDATAPROXYORNIL(n)                    (ISQITEMMODELBARDATAPROXY(n) || HB_ISNIL(n))
#define ISQITEMMODELSCATTERDATAPROXYORNIL(n)                (ISQITEMMODELSCATTERDATAPROXY(n) || HB_ISNIL(n))
#define ISQITEMMODELSURFACEDATAPROXYORNIL(n)                (ISQITEMMODELSURFACEDATAPROXY(n) || HB_ISNIL(n))
#define ISQLOGVALUE3DAXISFORMATTERORNIL(n)                  (ISQLOGVALUE3DAXISFORMATTER(n) || HB_ISNIL(n))
#define ISQSCATTER3DSERIESORNIL(n)                          (ISQSCATTER3DSERIES(n) || HB_ISNIL(n))
#define ISQSCATTERDATAITEMORNIL(n)                          (ISQSCATTERDATAITEM(n) || HB_ISNIL(n))
#define ISQSCATTERDATAPROXYORNIL(n)                         (ISQSCATTERDATAPROXY(n) || HB_ISNIL(n))
#define ISQSURFACE3DSERIESORNIL(n)                          (ISQSURFACE3DSERIES(n) || HB_ISNIL(n))
#define ISQSURFACEDATAITEMORNIL(n)                          (ISQSURFACEDATAITEM(n) || HB_ISNIL(n))
#define ISQSURFACEDATAPROXYORNIL(n)                         (ISQSURFACEDATAPROXY(n) || HB_ISNIL(n))
#define ISQTOUCH3DINPUTHANDLERORNIL(n)                      (ISQTOUCH3DINPUTHANDLER(n) || HB_ISNIL(n))
#define ISQVALUE3DAXISORNIL(n)                              (ISQVALUE3DAXIS(n) || HB_ISNIL(n))
#define ISQVALUE3DAXISFORMATTERORNIL(n)                     (ISQVALUE3DAXISFORMATTER(n) || HB_ISNIL(n))
...
#define PQ3DCAMERA_CAMERAPRESET(n)                          static_cast<Q3DCamera::CameraPreset>(hb_parni(n))
#define PQ3DTHEME_COLORSTYLE(n)                             static_cast<Q3DTheme::ColorStyle>(hb_parni(n))
#define PQ3DTHEME_THEME(n)                                  static_cast<Q3DTheme::Theme>(hb_parni(n))
#define PQABSTRACT3DAXIS_AXISORIENTATION(n)                 static_cast<QAbstract3DAxis::AxisOrientation>(hb_parni(n))
#define PQABSTRACT3DAXIS_AXISTYPE(n)                        static_cast<QAbstract3DAxis::AxisType>(hb_parni(n))
#define PQABSTRACT3DGRAPH_ELEMENTTYPE(n)                    static_cast<QAbstract3DGraph::ElementType>(hb_parni(n))
#define PQABSTRACT3DGRAPH_OPTIMIZATIONHINTS(n)              static_cast<QAbstract3DGraph::OptimizationHints>(hb_parni(n))
#define PQABSTRACT3DGRAPH_SELECTIONFLAGS(n)                 static_cast<QAbstract3DGraph::SelectionFlags>(hb_parni(n))
#define PQABSTRACT3DGRAPH_SHADOWQUALITY(n)                  static_cast<QAbstract3DGraph::ShadowQuality>(hb_parni(n))
#define PQABSTRACT3DINPUTHANDLER_INPUTVIEW(n)               static_cast<QAbstract3DInputHandler::InputView>(hb_parni(n))
#define PQABSTRACT3DSERIES_MESH(n)                          static_cast<QAbstract3DSeries::Mesh>(hb_parni(n))
#define PQABSTRACT3DSERIES_SERIESTYPE(n)                    static_cast<QAbstract3DSeries::SeriesType>(hb_parni(n))
#define PQABSTRACTDATAPROXY_DATATYPE(n)                     static_cast<QAbstractDataProxy::DataType>(hb_parni(n))
#define PQITEMMODELBARDATAPROXY_MULTIMATCHBEHAVIOR(n)       static_cast<QItemModelBarDataProxy::MultiMatchBehavior>(hb_parni(n))
#define PQITEMMODELSURFACEDATAPROXY_MULTIMATCHBEHAVIOR(n)   static_cast<QItemModelSurfaceDataProxy::MultiMatchBehavior>(hb_parni(n))
#define PQSURFACE3DSERIES_DRAWFLAGS(n)                      static_cast<QSurface3DSeries::DrawFlags>(hb_parni(n))

#define RQBARDATAITEM(exp)                                  Qt5xHb::createReturnClass(new QBarDataItem(exp), "QBARDATAITEM", true)
#define RQSCATTERDATAITEM(exp)                              Qt5xHb::createReturnClass(new QScatterDataItem(exp), "QSCATTERDATAITEM", true)
#define RQSURFACEDATAITEM(exp)                              Qt5xHb::createReturnClass(new QSurfaceDataItem(exp), "QSURFACEDATAITEM", true)

#endif // QT5XHB_MACROS_QTDATAVISUALIZATION_HPP
