...
#ifndef QT5XHB_MACROS_QTQUICK_HPP
#define QT5XHB_MACROS_QTQUICK_HPP
...
#define ISQQUICKIMAGEPROVIDERORNIL(n)                       (ISQQUICKIMAGEPROVIDER(n) || HB_ISNIL(n))
#define ISQQUICKITEMORNIL(n)                                (ISQQUICKITEM(n) || HB_ISNIL(n))
#define ISQQUICKPAINTEDITEMORNIL(n)                         (ISQQUICKPAINTEDITEM(n) || HB_ISNIL(n))
#define ISQQUICKTEXTUREFACTORYORNIL(n)                      (ISQQUICKTEXTUREFACTORY(n) || HB_ISNIL(n))
#define ISQQUICKVIEWORNIL(n)                                (ISQQUICKVIEW(n) || HB_ISNIL(n))
#define ISQQUICKWINDOWORNIL(n)                              (ISQQUICKWINDOW(n) || HB_ISNIL(n))
#define ISQSGBASICGEOMETRYNODEORNIL(n)                      (ISQSGBASICGEOMETRYNODE(n) || HB_ISNIL(n))
#define ISQSGCLIPNODEORNIL(n)                               (ISQSGCLIPNODE(n) || HB_ISNIL(n))
#define ISQSGDYNAMICTEXTUREORNIL(n)                         (ISQSGDYNAMICTEXTURE(n) || HB_ISNIL(n))
#define ISQSGFLATCOLORMATERIALORNIL(n)                      (ISQSGFLATCOLORMATERIAL(n) || HB_ISNIL(n))
#define ISQSGGEOMETRYORNIL(n)                               (ISQSGGEOMETRY(n) || HB_ISNIL(n))
#define ISQSGGEOMETRYNODEORNIL(n)                           (ISQSGGEOMETRYNODE(n) || HB_ISNIL(n))
#define ISQSGMATERIALORNIL(n)                               (ISQSGMATERIAL(n) || HB_ISNIL(n))
#define ISQSGMATERIALSHADERORNIL(n)                         (ISQSGMATERIALSHADER(n) || HB_ISNIL(n))
#define ISQSGMATERIALTYPEORNIL(n)                           (ISQSGMATERIALTYPE(n) || HB_ISNIL(n))
#define ISQSGNODEORNIL(n)                                   (ISQSGNODE(n) || HB_ISNIL(n))
#define ISQSGOPACITYNODEORNIL(n)                            (ISQSGOPACITYNODE(n) || HB_ISNIL(n))
#define ISQSGSIMPLEMATERIALORNIL(n)                         (ISQSGSIMPLEMATERIAL(n) || HB_ISNIL(n))
#define ISQSGSIMPLEMATERIALSHADERORNIL(n)                   (ISQSGSIMPLEMATERIALSHADER(n) || HB_ISNIL(n))
#define ISQSGSIMPLETEXTURENODEORNIL(n)                      (ISQSGSIMPLETEXTURENODE(n) || HB_ISNIL(n))
#define ISQSGTEXTUREORNIL(n)                                (ISQSGTEXTURE(n) || HB_ISNIL(n))
#define ISQSGTRANSFORMNODEORNIL(n)                          (ISQSGTRANSFORMNODE(n) || HB_ISNIL(n))
#define ISQSGVERTEXCOLORMATERIALORNIL(n)                    (ISQSGVERTEXCOLORMATERIAL(n) || HB_ISNIL(n))
...
#define PQQUICKITEM_FLAG(n)                                 static_cast<QQuickItem::Flag>(hb_parni(n))
#define PQQUICKITEM_FLAGS(n)                                static_cast<QQuickItem::Flags>(hb_parni(n))
#define PQQUICKITEM_TRANSFORMORIGIN(n)                      static_cast<QQuickItem::TransformOrigin>(hb_parni(n))
#define PQQUICKPAINTEDITEM_PERFORMANCEHINT(n)               static_cast<QQuickPaintedItem::PerformanceHint>(hb_parni(n))
#define PQQUICKPAINTEDITEM_PERFORMANCEHINTS(n)              static_cast<QQuickPaintedItem::PerformanceHints>(hb_parni(n))
#define PQQUICKPAINTEDITEM_RENDERTARGET(n)                  static_cast<QQuickPaintedItem::RenderTarget>(hb_parni(n))
#define PQQUICKVIEW_RESIZEMODE(n)                           static_cast<QQuickView::ResizeMode>(hb_parni(n))
#define PQQUICKVIEW_STATUS(n)                               static_cast<QQuickView::Status>(hb_parni(n))
#define PQQUICKWINDOW_CREATETEXTUREOPTIONS(n)               static_cast<QQuickWindow::CreateTextureOptions>(hb_parni(n))
#define PQQUICKWINDOW_SCENEGRAPHERROR(n)                    static_cast<QQuickWindow::SceneGraphError>(hb_parni(n))
#define PQSGGEOMETRY_DATAPATTERN(n)                         static_cast<QSGGeometry::DataPattern>(hb_parni(n))
#define PQSGMATERIAL_FLAGS(n)                               static_cast<QSGMaterial::Flags>(hb_parni(n))
#define PQSGNODE_DIRTYSTATE(n)                              static_cast<QSGNode::DirtyState>(hb_parni(n))
#define PQSGNODE_FLAG(n)                                    static_cast<QSGNode::Flag>(hb_parni(n))
#define PQSGNODE_FLAGS(n)                                   static_cast<QSGNode::Flags>(hb_parni(n))
#define PQSGNODE_NODETYPE(n)                                static_cast<QSGNode::NodeType>(hb_parni(n))
#define PQSGTEXTURE_FILTERING(n)                            static_cast<QSGTexture::Filtering>(hb_parni(n))
#define PQSGTEXTURE_WRAPMODE(n)                             static_cast<QSGTexture::WrapMode>(hb_parni(n))

#define RQQUICKIMAGEPROVIDER(exp)                           Qt5xHb::createReturnClass(new QQuickImageProvider(exp), "QQUICKIMAGEPROVIDER", true)
#define RQSGBASICGEOMETRYNODE(exp)                          Qt5xHb::createReturnClass(new QSGBasicGeometryNode(exp), "QSGBASICGEOMETRYNODE", true)
#define RQSGCLIPNODE(exp)                                   Qt5xHb::createReturnClass(new QSGClipNode(exp), "QSGCLIPNODE", true)
#define RQSGFLATCOLORMATERIAL(exp)                          Qt5xHb::createReturnClass(new QSGFlatColorMaterial(exp), "QSGFLATCOLORMATERIAL", true)
#define RQSGGEOMETRY(exp)                                   Qt5xHb::createReturnClass(new QSGGeometry(exp), "QSGGEOMETRY", true)
#define RQSGGEOMETRYNODE(exp)                               Qt5xHb::createReturnClass(new QSGGeometryNode(exp), "QSGGEOMETRYNODE", true)
#define RQSGMATERIAL(exp)                                   Qt5xHb::createReturnClass(new QSGMaterial(exp), "QSGMATERIAL", true)
#define RQSGMATERIALSHADER(exp)                             Qt5xHb::createReturnClass(new QSGMaterialShader(exp), "QSGMATERIALSHADER", true)
#define RQSGMATERIALTYPE(exp)                               Qt5xHb::createReturnClass(new QSGMaterialType(exp), "QSGMATERIALTYPE", true)
#define RQSGNODE(exp)                                       Qt5xHb::createReturnClass(new QSGNode(exp), "QSGNODE", true)
#define RQSGOPACITYNODE(exp)                                Qt5xHb::createReturnClass(new QSGOpacityNode(exp), "QSGOPACITYNODE", true)
#define RQSGSIMPLEMATERIAL(exp)                             Qt5xHb::createReturnClass(new QSGSimpleMaterial(exp), "QSGSIMPLEMATERIAL", true)
#define RQSGSIMPLEMATERIALSHADER(exp)                       Qt5xHb::createReturnClass(new QSGSimpleMaterialShader(exp), "QSGSIMPLEMATERIALSHADER", true)
#define RQSGSIMPLETEXTURENODE(exp)                          Qt5xHb::createReturnClass(new QSGSimpleTextureNode(exp), "QSGSIMPLETEXTURENODE", true)
#define RQSGTRANSFORMNODE(exp)                              Qt5xHb::createReturnClass(new QSGTransformNode(exp), "QSGTRANSFORMNODE", true)
#define RQSGVERTEXCOLORMATERIAL(exp)                        Qt5xHb::createReturnClass(new QSGVertexColorMaterial(exp), "QSGVERTEXCOLORMATERIAL", true)

#endif // QT5XHB_MACROS_QTQUICK_HPP
