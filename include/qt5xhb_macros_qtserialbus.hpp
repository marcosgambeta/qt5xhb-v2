...
#ifndef QT5XHB_MACROS_QTSERIALBUS_HPP
#define QT5XHB_MACROS_QTSERIALBUS_HPP
...
#define ISQCANBUSORNIL(n)                                   (ISQCANBUS(n) || HB_ISNIL(n))
#define ISQCANBUSDEVICEORNIL(n)                             (ISQCANBUSDEVICE(n) || HB_ISNIL(n))
#define ISQCANBUSDEVICEINFOORNIL(n)                         (ISQCANBUSDEVICEINFO(n) || HB_ISNIL(n))
#define ISQCANBUSFACTORYORNIL(n)                            (ISQCANBUSFACTORY(n) || HB_ISNIL(n))
#define ISQCANBUSFACTORYV2ORNIL(n)                          (ISQCANBUSFACTORYV2(n) || HB_ISNIL(n))
#define ISQCANBUSFRAMEORNIL(n)                              (ISQCANBUSFRAME(n) || HB_ISNIL(n))
#define ISQMODBUSCLIENTORNIL(n)                             (ISQMODBUSCLIENT(n) || HB_ISNIL(n))
#define ISQMODBUSDEVICEORNIL(n)                             (ISQMODBUSDEVICE(n) || HB_ISNIL(n))
#define ISQMODBUSREPLYORNIL(n)                              (ISQMODBUSREPLY(n) || HB_ISNIL(n))
#define ISQMODBUSRTUSERIALMASTERORNIL(n)                    (ISQMODBUSRTUSERIALMASTER(n) || HB_ISNIL(n))
#define ISQMODBUSRTUSERIALSLAVEORNIL(n)                     (ISQMODBUSRTUSERIALSLAVE(n) || HB_ISNIL(n))
#define ISQMODBUSSERVERORNIL(n)                             (ISQMODBUSSERVER(n) || HB_ISNIL(n))
#define ISQMODBUSTCPCLIENTORNIL(n)                          (ISQMODBUSTCPCLIENT(n) || HB_ISNIL(n))
#define ISQMODBUSTCPSERVERORNIL(n)                          (ISQMODBUSTCPSERVER(n) || HB_ISNIL(n))
...
#define PQCANBUSDEVICE_CANBUSDEVICESTATE(n)                 static_cast<QCanBusDevice::CanBusDeviceState>(hb_parni(n))
#define PQCANBUSDEVICE_CANBUSERROR(n)                       static_cast<QCanBusDevice::CanBusError>(hb_parni(n))
#define PQCANBUSDEVICE_DIRECTIONS(n)                        static_cast<QCanBusDevice::Directions>(hb_parni(n))
#define PQCANBUSFRAME_FRAMEERRORS(n)                        static_cast<QCanBusFrame::FrameErrors>(hb_parni(n))
#define PQCANBUSFRAME_FRAMETYPE(n)                          static_cast<QCanBusFrame::FrameType>(hb_parni(n))
#define PQMODBUSDATAUNIT_REGISTERTYPE(n)                    static_cast<QModbusDataUnit::RegisterType>(hb_parni(n))
#define PQMODBUSDEVICE_ERROR(n)                             static_cast<QModbusDevice::Error>(hb_parni(n))
#define PQMODBUSDEVICE_STATE(n)                             static_cast<QModbusDevice::State>(hb_parni(n))
#define PQMODBUSREPLY_REPLYTYPE(n)                          static_cast<QModbusReply::ReplyType>(hb_parni(n))

#define RQCANBUSDEVICEINFO(exp)                             Qt5xHb::createReturnClass(new QCanBusDeviceInfo(exp), "QCANBUSDEVICEINFO", true)
#define RQCANBUSFACTORY(exp)                                Qt5xHb::createReturnClass(new QCanBusFactory(exp), "QCANBUSFACTORY", true)
#define RQCANBUSFACTORYV2(exp)                              Qt5xHb::createReturnClass(new QCanBusFactoryV2(exp), "QCANBUSFACTORYV2", true)
#define RQCANBUSFRAME(exp)                                  Qt5xHb::createReturnClass(new QCanBusFrame(exp), "QCANBUSFRAME", true)

#endif // QT5XHB_MACROS_QTSERIALBUS_HPP
