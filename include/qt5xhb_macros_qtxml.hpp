...
#ifndef QT5XHB_MACROS_QTXML_HPP
#define QT5XHB_MACROS_QTXML_HPP
...
#define ISQDOMATTRORNIL(n)                                  (ISQDOMATTR(n) || HB_ISNIL(n))
#define ISQDOMCDATASECTIONORNIL(n)                          (ISQDOMCDATASECTION(n) || HB_ISNIL(n))
#define ISQDOMCHARACTERDATAORNIL(n)                         (ISQDOMCHARACTERDATA(n) || HB_ISNIL(n))
#define ISQDOMCOMMENTORNIL(n)                               (ISQDOMCOMMENT(n) || HB_ISNIL(n))
#define ISQDOMDOCUMENTORNIL(n)                              (ISQDOMDOCUMENT(n) || HB_ISNIL(n))
#define ISQDOMDOCUMENTFRAGMENTORNIL(n)                      (ISQDOMDOCUMENTFRAGMENT(n) || HB_ISNIL(n))
#define ISQDOMDOCUMENTTYPEORNIL(n)                          (ISQDOMDOCUMENTTYPE(n) || HB_ISNIL(n))
#define ISQDOMELEMENTORNIL(n)                               (ISQDOMELEMENT(n) || HB_ISNIL(n))
#define ISQDOMENTITYORNIL(n)                                (ISQDOMENTITY(n) || HB_ISNIL(n))
#define ISQDOMENTITYREFERENCEORNIL(n)                       (ISQDOMENTITYREFERENCE(n) || HB_ISNIL(n))
#define ISQDOMIMPLEMENTATIONORNIL(n)                        (ISQDOMIMPLEMENTATION(n) || HB_ISNIL(n))
#define ISQDOMNAMEDNODEMAPORNIL(n)                          (ISQDOMNAMEDNODEMAP(n) || HB_ISNIL(n))
#define ISQDOMNODEORNIL(n)                                  (ISQDOMNODE(n) || HB_ISNIL(n))
#define ISQDOMNODELISTORNIL(n)                              (ISQDOMNODELIST(n) || HB_ISNIL(n))
#define ISQDOMNOTATIONORNIL(n)                              (ISQDOMNOTATION(n) || HB_ISNIL(n))
#define ISQDOMPROCESSINGINSTRUCTIONORNIL(n)                 (ISQDOMPROCESSINGINSTRUCTION(n) || HB_ISNIL(n))
#define ISQDOMTEXTORNIL(n)                                  (ISQDOMTEXT(n) || HB_ISNIL(n))
#define ISQXMLATTRIBUTESORNIL(n)                            (ISQXMLATTRIBUTES(n) || HB_ISNIL(n))
#define ISQXMLCONTENTHANDLERORNIL(n)                        (ISQXMLCONTENTHANDLER(n) || HB_ISNIL(n))
#define ISQXMLDECLHANDLERORNIL(n)                           (ISQXMLDECLHANDLER(n) || HB_ISNIL(n))
#define ISQXMLDEFAULTHANDLERORNIL(n)                        (ISQXMLDEFAULTHANDLER(n) || HB_ISNIL(n))
#define ISQXMLDTDHANDLERORNIL(n)                            (ISQXMLDTDHANDLER(n) || HB_ISNIL(n))
#define ISQXMLENTITYRESOLVERORNIL(n)                        (ISQXMLENTITYRESOLVER(n) || HB_ISNIL(n))
#define ISQXMLERRORHANDLERORNIL(n)                          (ISQXMLERRORHANDLER(n) || HB_ISNIL(n))
#define ISQXMLINPUTSOURCEORNIL(n)                           (ISQXMLINPUTSOURCE(n) || HB_ISNIL(n))
#define ISQXMLLEXICALHANDLERORNIL(n)                        (ISQXMLLEXICALHANDLER(n) || HB_ISNIL(n))
#define ISQXMLLOCATORORNIL(n)                               (ISQXMLLOCATOR(n) || HB_ISNIL(n))
#define ISQXMLNAMESPACESUPPORTORNIL(n)                      (ISQXMLNAMESPACESUPPORT(n) || HB_ISNIL(n))
#define ISQXMLPARSEEXCEPTIONORNIL(n)                        (ISQXMLPARSEEXCEPTION(n) || HB_ISNIL(n))
#define ISQXMLREADERORNIL(n)                                (ISQXMLREADER(n) || HB_ISNIL(n))
#define ISQXMLSIMPLEREADERORNIL(n)                          (ISQXMLSIMPLEREADER(n) || HB_ISNIL(n))
...
#define RQDOMATTR(exp)                                      Qt5xHb::createReturnClass(new QDomAttr(exp), "QDOMATTR", true)
#define RQDOMCDATASECTION(exp)                              Qt5xHb::createReturnClass(new QDomCDATASection(exp), "QDOMCDATASECTION", true)
#define RQDOMCHARACTERDATA(exp)                             Qt5xHb::createReturnClass(new QDomCharacterData(exp), "QDOMCHARACTERDATA", true)
#define RQDOMCOMMENT(exp)                                   Qt5xHb::createReturnClass(new QDomComment(exp), "QDOMCOMMENT", true)
#define RQDOMDOCUMENT(exp)                                  Qt5xHb::createReturnClass(new QDomDocument(exp), "QDOMDOCUMENT", true)
#define RQDOMDOCUMENTFRAGMENT(exp)                          Qt5xHb::createReturnClass(new QDomDocumentFragment(exp), "QDOMDOCUMENTFRAGMENT", true)
#define RQDOMDOCUMENTTYPE(exp)                              Qt5xHb::createReturnClass(new QDomDocumentType(exp), "QDOMDOCUMENTTYPE", true)
#define RQDOMELEMENT(exp)                                   Qt5xHb::createReturnClass(new QDomElement(exp), "QDOMELEMENT", true)
#define RQDOMENTITY(exp)                                    Qt5xHb::createReturnClass(new QDomEntity(exp), "QDOMENTITY", true)
#define RQDOMENTITYREFERENCE(exp)                           Qt5xHb::createReturnClass(new QDomEntityReference(exp), "QDOMENTITYREFERENCE", true)
#define RQDOMIMPLEMENTATION(exp)                            Qt5xHb::createReturnClass(new QDomImplementation(exp), "QDOMIMPLEMENTATION", true)
#define RQDOMNAMEDNODEMAP(exp)                              Qt5xHb::createReturnClass(new QDomNamedNodeMap(exp), "QDOMNAMEDNODEMAP", true)
#define RQDOMNODE(exp)                                      Qt5xHb::createReturnClass(new QDomNode(exp), "QDOMNODE", true)
#define RQDOMNODELIST(exp)                                  Qt5xHb::createReturnClass(new QDomNodeList(exp), "QDOMNODELIST", true)
#define RQDOMNOTATION(exp)                                  Qt5xHb::createReturnClass(new QDomNotation(exp), "QDOMNOTATION", true)
#define RQDOMPROCESSINGINSTRUCTION(exp)                     Qt5xHb::createReturnClass(new QDomProcessingInstruction(exp), "QDOMPROCESSINGINSTRUCTION", true)
#define RQDOMTEXT(exp)                                      Qt5xHb::createReturnClass(new QDomText(exp), "QDOMTEXT", true)
#define RQXMLATTRIBUTES(exp)                                Qt5xHb::createReturnClass(new QXmlAttributes(exp), "QXMLATTRIBUTES", true)
#define RQXMLCONTENTHANDLER(exp)                            Qt5xHb::createReturnClass(new QXmlContentHandler(exp), "QXMLCONTENTHANDLER", true)
#define RQXMLDECLHANDLER(exp)                               Qt5xHb::createReturnClass(new QXmlDeclHandler(exp), "QXMLDECLHANDLER", true)
#define RQXMLDEFAULTHANDLER(exp)                            Qt5xHb::createReturnClass(new QXmlDefaultHandler(exp), "QXMLDEFAULTHANDLER", true)
#define RQXMLDTDHANDLER(exp)                                Qt5xHb::createReturnClass(new QXmlDTDHandler(exp), "QXMLDTDHANDLER", true)
#define RQXMLENTITYRESOLVER(exp)                            Qt5xHb::createReturnClass(new QXmlEntityResolver(exp), "QXMLENTITYRESOLVER", true)
#define RQXMLERRORHANDLER(exp)                              Qt5xHb::createReturnClass(new QXmlErrorHandler(exp), "QXMLERRORHANDLER", true)
#define RQXMLINPUTSOURCE(exp)                               Qt5xHb::createReturnClass(new QXmlInputSource(exp), "QXMLINPUTSOURCE", true)
#define RQXMLLEXICALHANDLER(exp)                            Qt5xHb::createReturnClass(new QXmlLexicalHandler(exp), "QXMLLEXICALHANDLER", true)
#define RQXMLLOCATOR(exp)                                   Qt5xHb::createReturnClass(new QXmlLocator(exp), "QXMLLOCATOR", true)
#define RQXMLNAMESPACESUPPORT(exp)                          Qt5xHb::createReturnClass(new QXmlNamespaceSupport(exp), "QXMLNAMESPACESUPPORT", true)
#define RQXMLPARSEEXCEPTION(exp)                            Qt5xHb::createReturnClass(new QXmlParseException(exp), "QXMLPARSEEXCEPTION", true)
#define RQXMLREADER(exp)                                    Qt5xHb::createReturnClass(new QXmlReader(exp), "QXMLREADER", true)
#define RQXMLSIMPLEREADER(exp)                              Qt5xHb::createReturnClass(new QXmlSimpleReader(exp), "QXMLSIMPLEREADER", true)

#endif // QT5XHB_MACROS_QTXML_HPP
