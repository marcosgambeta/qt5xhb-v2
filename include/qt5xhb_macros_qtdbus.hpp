...
#define PQDBUS_CALLMODE(n)                                  static_cast<QDBus::CallMode>(hb_parni(n))
#define PQDBUSARGUMENT_ELEMENTTYPE(n)                       static_cast<QDBusArgument::ElementType>(hb_parni(n))
#define PQDBUSCONNECTION_BUSTYPE(n)                         static_cast<QDBusConnection::BusType>(hb_parni(n))
#define PQDBUSCONNECTION_CONNECTIONCAPABILITIES(n)          static_cast<QDBusConnection::ConnectionCapabilities>(hb_parni(n))
#define PQDBUSCONNECTION_REGISTEROPTIONS(n)                 static_cast<QDBusConnection::RegisterOptions>(hb_parni(n))
#define PQDBUSCONNECTION_UNREGISTERMODE(n)                  static_cast<QDBusConnection::UnregisterMode>(hb_parni(n))
#define PQDBUSCONNECTIONINTERFACE_SERVICEQUEUEOPTIONS(n)    static_cast<QDBusConnectionInterface::ServiceQueueOptions>(hb_parni(n))
#define PQDBUSCONNECTIONINTERFACE_SERVICEREPLACEMENTOPTIONS(n) static_cast<QDBusConnectionInterface::ServiceReplacementOptions>(hb_parni(n))
#define PQDBUSERROR_ERRORTYPE(n)                            static_cast<QDBusError::ErrorType>(hb_parni(n))
#define PQDBUSMESSAGE_MESSAGETYPE(n)                        static_cast<QDBusMessage::MessageType>(hb_parni(n))
#define PQDBUSSERVICEWATCHER_WATCHMODE(n)                   static_cast<QDBusServiceWatcher::WatchMode>(hb_parni(n))

#define RQDBUSARGUMENT(exp)                                 Qt5xHb::createReturnClass(new QDBusArgument(exp), "QDBUSARGUMENT", true)
#define RQDBUSCONNECTION(exp)                               Qt5xHb::createReturnClass(new QDBusConnection(exp), "QDBUSCONNECTION", true)
#define RQDBUSCONTEXT(exp)                                  Qt5xHb::createReturnClass(new QDBusContext(exp), "QDBUSCONTEXT", true)
#define RQDBUSERROR(exp)                                    Qt5xHb::createReturnClass(new QDBusError(exp), "QDBUSERROR", true)
#define RQDBUSMESSAGE(exp)                                  Qt5xHb::createReturnClass(new QDBusMessage(exp), "QDBUSMESSAGE", true)
#define RQDBUSMETATYPE(exp)                                 Qt5xHb::createReturnClass(new QDBusMetaType(exp), "QDBUSMETATYPE", true)
#define RQDBUSOBJECTPATH(exp)                               Qt5xHb::createReturnClass(new QDBusObjectPath(exp), "QDBUSOBJECTPATH", true)
#define RQDBUSPENDINGCALL(exp)                              Qt5xHb::createReturnClass(new QDBusPendingCall(exp), "QDBUSPENDINGCALL", true)
#define RQDBUSPENDINGREPLYDATA(exp)                         Qt5xHb::createReturnClass(new QDBusPendingReplyData(exp), "QDBUSPENDINGREPLYDATA", true)
#define RQDBUSSIGNATURE(exp)                                Qt5xHb::createReturnClass(new QDBusSignature(exp), "QDBUSSIGNATURE", true)
#define RQDBUSUNIXFILEDESCRIPTOR(exp)                       Qt5xHb::createReturnClass(new QDBusUnixFileDescriptor(exp), "QDBUSUNIXFILEDESCRIPTOR", true)
