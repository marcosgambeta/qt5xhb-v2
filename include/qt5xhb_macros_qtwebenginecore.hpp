...
#ifndef QT5XHB_MACROS_QTWEBENGINECORE_HPP
#define QT5XHB_MACROS_QTWEBENGINECORE_HPP
...
#define ISQWEBENGINECOOKIESTOREORNIL(n)                     (ISQWEBENGINECOOKIESTORE(n) || HB_ISNIL(n))
#define ISQWEBENGINEHTTPREQUESTORNIL(n)                     (ISQWEBENGINEHTTPREQUEST(n) || HB_ISNIL(n))
#define ISQWEBENGINEURLREQUESTINFOORNIL(n)                  (ISQWEBENGINEURLREQUESTINFO(n) || HB_ISNIL(n))
#define ISQWEBENGINEURLREQUESTINTERCEPTORORNIL(n)           (ISQWEBENGINEURLREQUESTINTERCEPTOR(n) || HB_ISNIL(n))
#define ISQWEBENGINEURLREQUESTJOBORNIL(n)                   (ISQWEBENGINEURLREQUESTJOB(n) || HB_ISNIL(n))
#define ISQWEBENGINEURLSCHEMEHANDLERORNIL(n)                (ISQWEBENGINEURLSCHEMEHANDLER(n) || HB_ISNIL(n))
...
#define PQWEBENGINEHTTPREQUEST_METHOD(n)                    static_cast<QWebEngineHttpRequest::Method>(hb_parni(n))
#define PQWEBENGINEURLREQUESTINFO_NAVIGATIONTYPE(n)         static_cast<QWebEngineUrlRequestInfo::NavigationType>(hb_parni(n))
#define PQWEBENGINEURLREQUESTINFO_RESOURCETYPE(n)           static_cast<QWebEngineUrlRequestInfo::ResourceType>(hb_parni(n))
#define PQWEBENGINEURLREQUESTJOB_ERROR(n)                   static_cast<QWebEngineUrlRequestJob::Error>(hb_parni(n))

#define RQWEBENGINEHTTPREQUEST(exp)                         Qt5xHb::createReturnClass(new QWebEngineHttpRequest(exp), "QWEBENGINEHTTPREQUEST", true)
#define RQWEBENGINEURLREQUESTINFO(exp)                      Qt5xHb::createReturnClass(new QWebEngineUrlRequestInfo(exp), "QWEBENGINEURLREQUESTINFO", true)

#endif // QT5XHB_MACROS_QTWEBENGINECORE_HPP
