...
#ifndef QT5XHB_MACROS_QTWINEXTRAS_HPP
#define QT5XHB_MACROS_QTWINEXTRAS_HPP
...
#define ISQTWINORNIL(n)                                     (ISQTWIN(n) || HB_ISNIL(n))
#define ISQWINCOLORIZATIONCHANGEEVENTORNIL(n)               (ISQWINCOLORIZATIONCHANGEEVENT(n) || HB_ISNIL(n))
#define ISQWINCOMPOSITIONCHANGEEVENTORNIL(n)                (ISQWINCOMPOSITIONCHANGEEVENT(n) || HB_ISNIL(n))
#define ISQWINEVENTORNIL(n)                                 (ISQWINEVENT(n) || HB_ISNIL(n))
#define ISQWINJUMPLISTORNIL(n)                              (ISQWINJUMPLIST(n) || HB_ISNIL(n))
#define ISQWINJUMPLISTCATEGORYORNIL(n)                      (ISQWINJUMPLISTCATEGORY(n) || HB_ISNIL(n))
#define ISQWINJUMPLISTITEMORNIL(n)                          (ISQWINJUMPLISTITEM(n) || HB_ISNIL(n))
#define ISQWINTASKBARBUTTONORNIL(n)                         (ISQWINTASKBARBUTTON(n) || HB_ISNIL(n))
#define ISQWINTASKBARPROGRESSORNIL(n)                       (ISQWINTASKBARPROGRESS(n) || HB_ISNIL(n))
#define ISQWINTHUMBNAILTOOLBARORNIL(n)                      (ISQWINTHUMBNAILTOOLBAR(n) || HB_ISNIL(n))
#define ISQWINTHUMBNAILTOOLBUTTONORNIL(n)                   (ISQWINTHUMBNAILTOOLBUTTON(n) || HB_ISNIL(n))
...
#define PQTWIN_HBITMAPFORMAT(n)                             static_cast<QtWin::HBitmapFormat>(hb_parni(n))
#define PQTWIN_WINDOWFLIP3DPOLICY(n)                        static_cast<QtWin::WindowFlip3DPolicy>(hb_parni(n))
#define PQWINJUMPLISTCATEGORY_TYPE(n)                       static_cast<QWinJumpListCategory::Type>(hb_parni(n))
#define PQWINJUMPLISTITEM_TYPE(n)                           static_cast<QWinJumpListItem::Type>(hb_parni(n))

#define RQTWIN(exp)                                         Qt5xHb::createReturnClass(new QtWin(exp), "QTWIN", true)
#define RQWINJUMPLISTCATEGORY(exp)                          Qt5xHb::createReturnClass(new QWinJumpListCategory(exp), "QWINJUMPLISTCATEGORY", true)
#define RQWINJUMPLISTITEM(exp)                              Qt5xHb::createReturnClass(new QWinJumpListItem(exp), "QWINJUMPLISTITEM", true)

#endif // QT5XHB_MACROS_QTWINEXTRAS_HPP
