...
$prototypeV2=virtual int bytesFree() const = 0
...
$prototypeV2=virtual void setVolume( qreal )

$prototypeV2=virtual qreal volume() const

$prototypeV2=virtual QString category() const

$prototypeV2=virtual void setCategory( const QString & )
