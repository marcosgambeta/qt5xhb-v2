...
$prototypeV2=void writeNamespace( const QString & namespaceUri, const QString & prefix = QString() )

$prototypeV2=void writeProcessingInstruction( const QString & target, const QString & data = QString() )
