...
$signal=5,4,0|categoryAdded( const QPlaceCategory & category, const QString & parentId )
$signal=5,4,0|categoryUpdated( const QPlaceCategory & category, const QString & parentId )
$signal=5,4,0|categoryRemoved( const QString & categoryId, const QString & parentId )
$signal=5,4,0|dataChanged()
$endSlotsClass
