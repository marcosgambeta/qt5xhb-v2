...
$prototypeV2=void addMapping( QAbstractChannelMapping * mapping )

$prototypeV2=void removeMapping( QAbstractChannelMapping * mapping )

$prototypeV2=QVector<QAbstractChannelMapping *> mappings() const
