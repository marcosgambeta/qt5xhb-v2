...
#define QWebEngineSettings_JavascriptCanAccessClipboard              3
#define QWebEngineSettings_LinksIncludedInFocusChain                 4
#define QWebEngineSettings_LocalStorageEnabled                       5
#define QWebEngineSettings_LocalContentCanAccessRemoteUrls           6
#define QWebEngineSettings_XSSAuditingEnabled                        7
#define QWebEngineSettings_SpatialNavigationEnabled                  8
#define QWebEngineSettings_LocalContentCanAccessFileUrls             9
