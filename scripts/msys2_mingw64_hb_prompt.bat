...
rem This script open a command prompt to work with Harbour and qt5xhb-v2 libraries.
...
rem Instructions:
rem Copy this script to the same folder where you have the script "msys2_mingw64_hb_build.bat".
...
set HB_BIN_DIR=%CD%\hb\bin
rem set HB_INC_DIR=%CD%\hb\include
